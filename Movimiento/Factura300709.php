											...
											<td colspan="4">
												<table class=rowtable width="100%">
													...
													<tr>
														...
														<td class="col2"><input name="NumeroFidelizacion" type="text" class="tbox" id="NumeroFidelizacion" value='<?php echo $r->NumeroFidelizacion?>' size="20" readonly="readonly" /></td>
													</tr>
													<tr>
														<td class=col1><br></td>
														<td class=col1></td>
