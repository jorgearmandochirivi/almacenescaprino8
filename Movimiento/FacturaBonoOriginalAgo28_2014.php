										...
										<tr>
											<td colspan="4">
												...
												<tr>
													...
													<td class=col2><input type="text" class="tbox" name="NumeroBono" size="20" value='<?echo $r->NumeroBono?>'></td>
												</tr>
													<tr>
													<td class=col1 nowrap>Valor ( $ )</td>
													<td class=col2><input type="text" class="tbox" name="ValorBono" size="20" value="<?echo $r->ValorBono?>" onblur="recalcularvalores()"></td>
													...
													<td class=col2><input type="text" class="tbox" name="CodigoTarjeta" size="20" value="<?echo $r->CodigoTarjeta?>" ></td>
													<td class=col1></td>
													<td class=col2></td>
												</tr>
											...
											<td colspan="4">
												<table class="texto" border="0" cellspacing="2" cellpadding="2" id=table1 align="center">
													...
													<tr >
														...
														<td align="center"><input type=text name=Cantidad<?=$i?> class=tbox size=5 onblur="if(!compruebamaximo(this.value,<?=$i?>)) this.value = ''; else calculatotal(this.value,<?=$i?>);"></td>
													<td align="left"><input type=text readonly name=ValorU<?=$i?> class=tbox size=10></td>
