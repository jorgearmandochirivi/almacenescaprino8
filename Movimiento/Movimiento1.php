							...
							<td class="row1" nowrap>
								<table width=100% cellspacing="1" cellpadding="1" bgcolor=#ffffff>
									...
									<tr>
										...
										<td class=col2><input type="text" class="input" name="TMovimiento" readonly size="24" value="Ingreso Contra Pedido"><input type="hidden" name="IDTipoMovimiento" value="<?php if($newmode == "insert") echo "1"; else echo  $r->IDTipoMovimiento;?>"><br>
										</td>
									</tr>
									<tr>
										<td class=col1>Empleado</td>
										<td class=col2><input type="text" class=input name="Empleado" value="<?php if($newmode == "insert") echo $ID_Usuario; else echo  $r->IDEmpleado;?>" readonly></td>
										<td class=col1></td>
										<td class=col1></td>
									</tr>
									<tr>
									...
									<tr>
										<td class=row1 colspan="4">
											<?php verdetallemovimiento($r->IDOrdenCompra);?>
										</td>
									</tr>
									<tr>
		...
		<table width=100% border=0 cellspacing=1 cellpadding=1 class=texto class="forumline" >
				...
				?>
					...
					<tr>
						...
						<td nowrap class="<?=$class?>"><?php echo $r->NumeroOrden?></td> <td nowrap class="<?=$class?>"><?php echo $r->FechaOrden?></td>
						<td nowrap class="<?=$class?>"><?php echo get_field("EstadoPedido","Descripcion","IDEstadoPedido",$r->IDEstadoPedido); ?></td>
					</tr>
				<?php } // END for
				?>
					<tr>
