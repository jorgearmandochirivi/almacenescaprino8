                                ...
                                <td colspan="2">
                                    ...
                                    <div class="siFidelizar hide" >
                                    	<table width="100%" border=0 cellspacing=1 cellpadding=1 class="texto forumline"  >
                                            ...
                                            <tr >
                                                <td width="40%" class="col1">Empleado</td><td class="col2"><?php echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ","Nombre","Apellidos","IDEmpleado",$r->IDIDEmpleado,"input\" id=\"Empleado"); ?></td>
                                            </tr>
...
<FORM name="frm" method="post" enctype="multipart/form-data" action="<?=$PHP_SELF?>" <?php if($newmode!="delete"){?>onsubmit="disable(this);return EvaluaReg(this,Check)"<?php }?>>
											...
											<td colspan="4">
												<table class=rowtable width="100%">
													...
													<tr>
														...
														<td class="col2"><input name="NumeroFidelizacion" type="text" class="tbox" id="NumeroFidelizacion" value='<?php echo $r->NumeroFidelizacion?>' size="20" /></td>
													</tr>
													<tr>
														<td class=col1><br></td>
														<td class=col1></td>
											...
											<td colspan="4" align=center>
												<table class="texto" width="100%" border="0" cellspacing="2" cellpadding="2" id=table1 align="center">
													...
													<tr >
														...
														<td align="left">
                                                        	<input readonly="readonly" type=text  name=Numero<?=$i?> rel="<?=$i ?>" value="<?php echo $frm[ $numero ] ?>" class="tbox " size=8>
                                 
                                 <?php
                                 $styletarjeta = "style=\"display:none\"";
								 if( !empty( $frm[ $codigotarjeta ] ) )
								 	$styletarjeta = " ";
								 ?>                           <input type="text" name="CodigoTarjeta<?=$i?>" id="CodigoTarjeta<?=$i?>" rel="<?=$i?>" value="<?php echo $frm[ $codigotarjeta ] ?>" <?=$styletarjeta ?> class="tbox " placeholder="Codigo Tarjeta" size=12 readonly="readonly" />
                                                            </td>
														...
														<td align="center"><input type=text name=Cantidad<?=$i?> id=Cantidad<?=$i?> value="<?php echo $frm[ $cantidad ] ?>" class="tbox" size=5 onblur="pague_2_lleve_3(); if(!compruebamaximo(this.value,<?=$i?>)) this.value = ''; else calculatotal(this.value,<?=$i?>);"></td>
													<td align="left"><input type=text readonly id="ValorU<?=$i?>" name=ValorU<?=$i?> value="<?php echo $frm[ $valoru ] ?>" class="tbox" size=10 onblur="setvalor(this.value,<?=$i?>);pague_2_lleve_3();calculatotal(this.value,<?=$i?>); "></td>
													<td align="center"><input type=text name="DescuentoLin<?=$i?>" value="<?php echo $frm[ $descuentolin ] ?>" onblur="calculatotal(this.value,<?=$i?>);" class="tbox" size=3 maxlength="3"></td>
													...
													<td align="left"><input type=hidden name=Maximo<?=$i?> value="<?php echo $frm[ $maximo ] ?>"></td>
														<td align="left"><input type=hidden name=Precio<?=$i?> value="<?php echo $frm[ $precio ] ?>"></td>
														<td align="left"><input type=button name=Borrar<?=$i?> class=submit value=Borrar onclick="Borrar(<?=$i?>);"><input type=hidden name=Descuento<?=$i?> value="<?php echo $frm[ $descuento ] ?>"></td>
													</tr>
													<?php
													}//end for
													?>
									...
									<tr>
										...
										<td class=col2><input type=text readonly value="<?php echo $frm[TotalSinIVA] ?>" name=TotalSinIVA class="tbox" size=15></td>
										</tr>
										<tr>
										<td class=col1></td>
										<td class=col1 width="250"></td>
										...
										<td class=col2><input type=text readonly name=ValorIVA value="<?php echo $frm[ValorIVA] ?>" class="tbox" size=15></td>
										</tr>
										<tr>
										<td class=col1></td>
										<td class=col1 width="250"></td>
										...
										<td class=col2><input type=text readonly name=ValorTotal value="<?php echo $frm[ValorTotal] ?>" class="tbox" size=15></td>
										</tr>
