...
if($permisos[0] >= 2)
{
		...
		switch (nvl($action)) {
			...
			case "insertar" :
				...
				$sql_verificafactura = " SELECT * FROM Factura WHERE NumeroFactura = '$HTTP_POST_VARS[NumeroFactura]' AND IDPuntoVenta = '$IDPuntoVenta'";
...
<table class="forumline" width="500" cellspacing="1" border="0" align="center">
	...
	<td>
		<table width=100% border=0 cellspacing=1 cellpadding=1 class="texto forumline"  >
                        ...
                        <?
                        if( !empty( $r->Fidelizado ) )
						{
							$msgfidelizado = "Cliente no fidelizado";
							if( $r->Fidelizado == "S" )
								$msgfidelizado = "Cliente fidelizado";
						?>
                        <tr >
						...
						if( $r->Fidelizado == "S" ) //SI ESTA FIDELIZADO SALE TODO Y LO DEJA ACTUALIZAR
						{
						?>
                            <tr >
                                <td width="40%" class="col1">C&eacute;dula ( <span class="rojo">*</span> )</td><td class=col2><input type=text size=25 class="tbox mandatory" title="Cedula"  name=Cedula id=Cedula value="<?=$r->Cedula ?>">
                                	<input type="hidden" name="Fidelizado" id="Fidelizado" value="S" />
                                 </td>
                            </tr>
                            ...
                            <tr >
                                <td class="col1" width="40%"> Nombre ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox mandatory" title="Nombre"   name=Nombre id=Nombre <?=$readonly ?> value="<?=$r->Nombre ?>"> </td>
                            </tr>
                            <tr >
                                <td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox mandatory" title="Apellido"   name=Apellido id=Apellidos <?=$readonly ?>  value="<?=$r->Apellido ?>"> </td>
                            </tr>
                            <tr >
                                <td class="col1" width="40%">G&eacute;nero</td>
                                <td class="col2"><? echo formradiogroup(array('Femenino'=>'F','Masculino'=>'M'),$r->Genero, 'Genero'); ?></td>
                            </tr>
                            <tr >
                                <td width="40%" class="col1"> Telefono ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox mandatory" title="Telefono"   name=Telefono id=Telefono value="<?=$r->Telefono ?>"> </td>
                            </tr>
                            <tr >
                                <td class="col1" width="40%">e-mail</td>
                                <td class="col2"><input type="text" class="tbox mandatory" title="Email" value="<?=$r->EMail ?>" name="EMail"></td>
                            </tr>
                            <tr >
                                <td width="40%" class="col1"> Celular </td><td class="col2"><input type=text size=25 class="tbox mandatory"  title="Celular"  name=Celular id=Celular value="<?=$r->Celular ?>"> </td>
                            </tr>
                            ...
                            <tr >
                                <td class="col1" width="40%">Autorizo a recibir mensajes de texto</td>
						...
						?>
                            <tr >
                                <td width="40%" class="col1">Fidelizar </td>
                                <td class=col2>
                                    
                                    <input type="radio" name="Fidelizado" class="radioFidelizado" value="S" > 
                                    Si
                                    <input type="radio" name="Fidelizado" class="radioFidelizado"  value="N">
                                    No
                                ...
                                <td colspan="2">
                                    ...
                                    <div class="noFidelizar hide" >
                                    	<table width="100%" border=0 cellspacing=1 cellpadding=1 class="texto forumline" >
                                            ...
                                            <tr >
                                                <td width="40%" class="col1">C&eacute;dula ( <span class="rojo">*</span> )</td><td class=col2><input type=text size=25 class="tbox" title="Cedula" value="<?=$cedula?>" name=Cedula id=Cedula > </td>
                                            </tr>
                                            ...
                                            <tr >
                                                <td class="col1" width="40%"> Nombre ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox" title="Nombre"  name=Nombre id=Nombre <?=$readonly ?> value="<?=$r->Nombre ?>"> </td>
                                            </tr>
                                            <tr >
                                                <td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox" title="Apellidos"  name=Apellido id=Apellidos <?=$readonly ?>  value="<?=$r->Apellido ?>"> </td>
                                            </tr>
                                            <tr >
                                                <td width="40%" class="col1">Empleado</td><td class="col2"><? echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ","Nombre","Apellidos","IDEmpleado",$r->IDEmpleado,"input\" id=\"Empleado"); ?></td>
                                            </tr>
                                    ...
                                    <div class="siFidelizar hide" >
                                    	<table width="100%" border=0 cellspacing=1 cellpadding=1 class="texto forumline"  >
                                            ...
                                            <tr >
                                                <td width="40%" class="col1">C&eacute;dula ( <span class="rojo">*</span> )</td><td class=col2><input type=text title="Cedula" size=25 class="tbox" value="<?=$cedula?>" name=Cedula id=Cedula > </td>
                                            </tr>
                                            ...
                                            <tr >
                                                <td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox" title="Apellido"  name=Apellido id=Apellidos <?=$readonly ?>  value="<?=$r->Apellido ?>"> </td>
                                            </tr>
                                            <tr >
                                                <td class="col1" width="40%">G&eacute;nero</td>
                                                <td class="col2"><? echo formradiogroup(array('Femenino'=>'F','Masculino'=>'M'),$r->Genero, 'Genero'); ?></td>
                                            ...
                                            <tr >
                                                <td width="40%" class="col1"> Telefono ( <span class="rojo">*</span> )</td><td class="col2"><input type=text size=25 class="tbox" title="Telefono"  name=Telefono id=Telefono value="<?=$r->Telefono ?>"> </td>
                                            </tr>
                                            <tr >
                                                <td class="col1" width="40%">e-mail</td>
                                                <td class="col2"><input type="text" class="tbox" title="Email" value="<?=$r->EMail ?>" name="EMail"></td>
                                            </tr>
                                            <tr >
                                            ...
                                            <tr >
                                                <td width="40%" class="col1">Empleado</td><td class="col2"><? echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ","Nombre","Apellidos","IDEmpleado",$r->IDIDEmpleado,"input\" id=\"Empleado"); ?></td>
                                            </tr>
...
<FORM name="frm" method="post" enctype="multipart/form-data" action="<?=$PHP_SELF?>" <?if($newmode!="delete"){?>onsubmit="disable(this);return EvaluaReg(this,Check)"<?}?>>
											...
											<td colspan="4">
												<table class=rowtable width="100%">
													<tr>
														...
														<td class=col2 colspan="3" ><input type="text" class="tbox" name="NumeroFactura" id="Numero Factura" size="24" value="<?=get_maxID("Factura WHERE IDPuntoVenta = '$IDPuntoVenta'","NumeroFactura") ?>"></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td class="col2"><input name="NumeroFidelizacion" type="text" class="tbox" id="NumeroFidelizacion" value='<?echo $r->NumeroFidelizacion?>' size="20" /></td>
													</tr>
													<tr>
														<td class=col1><br></td>
														<td class=col1></td>
													...
													<tr>
														...
														<td class=col2 colspan="3"><input type="text" class="tbox" name="Descuento" value="<? echo $frm[Descuento] ?>" size="3" value="" maxlength="3" onblur="recalcularvalores()">%</td>
													</tr>
													<tr>
														<td class=col1>Comentario </td>
														<td class=col2 colspan="3"><textarea class="tareabox" name="ObservacionDescuento" rows="4" cols="64"><? echo $frm[ObservacionDescuento] ?></textarea></td>
													</tr>
												</table>
									  </td>
										</tr>
											...
											<td colspan="4" align=center>
												<table class="texto" width="100%" border="0" cellspacing="2" cellpadding="2" id=table1 align="center">
													...
													<tr >
														...
														<td align="left"><input type=button name=Agregar<?=$i?> rel="<?=$i ?>" class=submit value=Referencia onclick="window.open('Referencia/popReferencias.php?IDPuntoVenta=<?=$IDPuntoVenta?>&cont=<?=$i?>','','scrollbars = yes,width=600,height=500');"></td>
														<td align="left">
                                                        	<input readonly="readonly" type=text  name=Numero<?=$i?> rel="<?=$i ?>" value="<? echo $frm[ $numero ] ?>" class="tbox " size=8>
                                 
                                 <?
                                 $styletarjeta = "style=\"display:none\"";
								 if( !empty( $frm[ $codigotarjeta ] ) )
								 	$styletarjeta = " ";
								 ?>                           <input type="text" name="CodigoTarjeta<?=$i?>" id="CodigoTarjeta<?=$i?>" rel="<?=$i?>" value="<? echo $frm[ $codigotarjeta ] ?>" <?=$styletarjeta ?> class="tbox " placeholder="Codigo Tarjeta" size=12 readonly="readonly" />
                                                            </td>
														<td align="left"><input type=text readonly name=Talla<?=$i?> value="<? echo $frm[ $talla ] ?>" class="tbox" size=5></td>
														<td align="left"><input type=text readonly name=Nombre<?=$i?> value="<? echo $frm[ $nombre ] ?>" class="tbox" size=10></td>
														<td align="left"><input type=hidden name=IDCodificacion<?=$i?> value="<? echo $frm[ $idcodificacion ] ?>" ></td>
														<td align="center"><input type=text name=Cantidad<?=$i?> id=Cantidad<?=$i?> value="<? echo $frm[ $cantidad ] ?>" class="tbox" size=5 onblur="pague_2_lleve_3(); if(!compruebamaximo(this.value,<?=$i?>)) this.value = ''; else calculatotal(this.value,<?=$i?>);"></td>
													<td align="left"><input type=text readonly id="ValorU<?=$i?>" name=ValorU<?=$i?> value="<? echo $frm[ $valoru ] ?>" class="tbox" size=10 onblur="setvalor(this.value,<?=$i?>);pague_2_lleve_3();calculatotal(this.value,<?=$i?>); "></td>
													<td align="center"><input type=text name="DescuentoLin<?=$i?>" value="<? echo $frm[ $descuentolin ] ?>" onblur="calculatotal(this.value,<?=$i?>);" class="tbox" size=3 maxlength="3"></td>
													...
													<td align="left"><input type=hidden name=Maximo<?=$i?> value="<? echo $frm[ $maximo ] ?>"></td>
														<td align="left"><input type=hidden name=Precio<?=$i?> value="<? echo $frm[ $precio ] ?>"></td>
														<td align="left"><input type=button name=Borrar<?=$i?> class=submit value=Borrar onclick="Borrar(<?=$i?>);"><input type=hidden name=Descuento<?=$i?> value="<? echo $frm[ $descuento ] ?>"></td>
													</tr>
													<?
													}//end for
													?>
									...
									<tr>
										...
										<td class=col2><input type=text readonly value="<? echo $frm[TotalSinIVA] ?>" name=TotalSinIVA class="tbox" size=15></td>
										</tr>
										<tr>
										<td class=col1></td>
										<td class=col1 width="250"></td>
										...
										<td class=col2><input type=text readonly name=ValorIVA value="<? echo $frm[ValorIVA] ?>" class="tbox" size=15></td>
										</tr>
										<tr>
										<td class=col1></td>
										<td class=col1 width="250"></td>
										...
										<td class=col2><input type=text readonly name=ValorTotal value="<? echo $frm[ValorTotal] ?>" class="tbox" size=15></td>
										</tr>
