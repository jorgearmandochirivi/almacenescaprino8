							...
							<td class="row1" nowrap>
								<table width=100% cellspacing="1" cellpadding="1" bgcolor=#ffffff>
									...
									<tr>
										...
										<td class=col2><input type="text" class=input name="Empleado" value="<?php if($newmode == "insert") echo $ID_Usuario; else echo  $r->IDEmpleado;?>"></td>
		...
		<table width=100% border=0 cellspacing=1 cellpadding=1 class=texto class="forumline" >
				...
				?>
					...
					<tr>
						...
						<td nowrap class="<?=$class?>"><?php echo get_field("TipoMovimiento","NombreMovimiento","IDTipoMovimiento",$r->IDTipoMovimiento)?></td> <td nowrap class="<?=$class?>"><?php echo $r->Fecha?></td>
