							...
							<td class="row1" nowrap>
								<table width=100% cellspacing="1" cellpadding="1" bgcolor=#ffffff>
									...
									<tr>
										...
										<td class=col2><input type="text" class=input name="Empleado" value='<? echo get_field("TipoMovimiento","NombreMovimiento","IDTipoMovimiento",$r->IDTipoMovimiento)?>' readonly>
										</td>
									</tr>
									<tr>
										<td class=col1>Empleado</td>
										<td class=col2><input type="text" class=input name="Empleado" value="<?if($newmode == "insert") echo $ID_Usuario; else echo  $r->IDEmpleado;?>"></td>
                                    ...
                                    <tr>
                                        <td class="row1" nowrap>
                                            <table width="500px" cellspacing="1" cellpadding="1" bgcolor=#ffffff align="center">
                                                ...
                                                <tr>
                                                  <td class=col1>Tipo de Movimiento</td>
                                                  <td class=col2><? echo get_field("TipoMovimiento","NombreMovimiento","IDTipoMovimiento",$r->IDTipoMovimiento)?></td>
                                                </tr>
                                                <tr>
                                                    <td class=col1>Empleado</td>
                                                    <td class=col2>
											...
											?></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td colspan="2" class=col1 nowrap width="200">Detalle Movimiento</td>
																								...
																								<tr>
                                                  <td colspan="2" class=col1 nowrap width="200"><?verdetallemovimiento_texto($r->IDMovimiento);?></td>
                                                </tr>
                                               </table>
																							 <br><br>
	...
	<td>
		<table width=100% border=0 cellspacing=1 cellpadding=1 class=texto class="forumline" >
					...
					<td align=center class=navpic valign=middle nowrap bgcolor=#DBEAF5>Crear</td>
						...
						<td class=navpic nowrap bgcolor=#DBEAF5><a href='<% echo "?mod=$MOD&field=".$_GET['field']."&IDPuntoVenta=".$IDPuntoVenta."&QryString=".$_GET['QryString']."&order_by=IDTipoMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'>Tipo Movimiento</a><a href='<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTipoMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'>&nbsp;<% if($_GET['order_by']=="IDTipoMovimiento"){%><img src="images/<%=$img%>" border=0><%}%></a></td>
						...
						<td class=navpic nowrap bgcolor=#DBEAF5><a href='<% echo "?mod=$MOD&field=".$_GET['field']."&IDPuntoVenta=".$IDPuntoVenta."&QryString=".$_GET['QryString']."&order_by=Remision&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'>Remision</a><a href='<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Remision&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'><% if($_GET['order_by']=="Remision"){%><img src="images/<%=$img%>" border=0><%}%></a></td>
					</tr>
				...
				?>
					...
					<tr>
						...
						<td nowrap class="<?=$class?>"><? echo get_field("TipoMovimiento","NombreMovimiento","IDTipoMovimiento",$r->IDTipoMovimiento)?></td> <td nowrap class="<?=$class?>"><? echo $r->Fecha?></td>
						<td nowrap class="<?=$class?>"><? echo $r->Remision; ?></td>
					</tr>
				<? } // END for
				?>
					<tr>
