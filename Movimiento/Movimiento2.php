...
*******************************************************************************************/
	...
	if(empty($sql))
	 	$sql =  "SELECT * FROM Pendientes WHERE  IDPuntoVenta = '$IDPuntoVenta' AND CantidadPendiente > 0 GROUP BY IDPuntoVentaReferencia ORDER BY IDPuntoVentaReferencia ASC";
