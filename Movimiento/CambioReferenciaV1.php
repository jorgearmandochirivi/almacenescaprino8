...
//reviso si estab habilitado el link
$sql_link = "Select * From LinkCambio Where 1 Limit 1";
...
if($row_link["Habilitar"]<>"S" || (int)$total_link_pto<=0):
	echo '<br><br><span style="color:#EE080C; font-size:18px; font-weight:bold">M&oacute;dulo no habilitado, pongase en contacto con el administrador</span>';
	exit;
endif;
