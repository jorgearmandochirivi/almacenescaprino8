					...
					<td colspan="2" width="100%">
								...
								<div align="center">
								 ...
								 ?>                           <input type="text" name="CodigoTarjeta<?=$i?>" id="CodigoTarjeta<?=$i?>" rel="<?=$i?>" value="<?php echo $frm[ $codigotarjeta ] ?>" <?=$styletarjeta ?> class="tbox " placeholder="Codigo Tarjeta" size=12 readonly="readonly" />
														...
														<td align="center"><input type=text name=Cantidad<?=$i?> id=Cantidad<?=$i?> value="<?php echo $frm[ $cantidad ] ?>" class="tbox" size=5 onblur="if(!compruebamaximo(this.value,<?=$i?>)) this.value = ''; else calculatotal(this.value,<?=$i?>);"></td>
													<td align="left"><input type=text readonly id="ValorU<?=$i?>" name=ValorU<?=$i?> value="<?php echo $frm[ $valoru ] ?>" class="tbox" size=10 onblur="setvalor(this.value,<?=$i?>); "></td>
