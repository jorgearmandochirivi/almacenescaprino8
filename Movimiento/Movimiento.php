...
?>
	...
	<td>
		...
		<table width=100% border=0 cellspacing=1 cellpadding=1 class=texto class="forumline" >
				...
				?>
					...
					<tr>
						...
						{
						?>
						<td nowrap class="navpic"><b><? echo get_field("Talla","Descripcion","IDTalla",$idtalla); ?></b></td>
						<?
						}
					...
					<tr>
						...
						{
						?>
						<td nowrap class="<?=$class?>"><b><? echo $cantidad; $TotalYaCargadas++; ?></b></td>
						<?
							$j++;
						}//end for
		...
		<!--LO QUE YA ESTA-->
		<br>
		<table width="100%"><tr><td class="navpic" width="240"><strong>TOTAL REFERENCIAS YA CARGADAS</strong></td><td align="left" class="navpic"><?=$TotalYaCargadas?></td></tr></table>
		<br>
		...
		<table width=100% border=0 cellspacing=1 cellpadding=1 class=texto class="forumline" >
						...
						?>
							<td nowrap class="<?=$class?>">
								...
								<? 
									...
									$TPares += $Ingr[$pend];
								?>
								<input type="text" size="5" name="Ingreso[<?=$datos[IDPuntoVentaReferencia]?>][<?=$datos[IDTalla]?>]"  value="<? echo $ingresotalla ?>">
				...
				?>
						...
						<tr>
							...
							<input type="submit" class="button" name="enviar" id="<?php if ($caption=="Confirmar Entrada") echo "envia_entrada"?>" value="<%=$caption%>">
                            </div>
						</td>
							<td></td>
