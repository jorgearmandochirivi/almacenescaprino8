											...
											<td colspan="4">
												<table class=rowtable width="100%">
													<tr>
                                                        ...
                                                        <input type="hidden" class="tbox" name="NumeroFacturaBono" id="Numero FacturaBono" size="24" value="<?=$consecutivosig ?>">
                                                        <?=$consecutivosig ?>
					 ...
					 ?>
							...
							<?php echo $msg_busca_bono; ?>
										...
										<tr>
                                          ...
                                          <input type="hidden" name="DescuentoAlianza" id="DescuentoAlianza" value="<?php echo $frm[ DescuentoAlianza ] ?>"></td>
									  </tr>
											...
											<td colspan="4">
												<table class="texto" border="0" cellspacing="2" cellpadding="2" id=table1 align="center">
													...
													<tr >
														...
														<td align="left"><input type=text readonly name=Numero<?=$i?> class=tbox size=8 data-required="true"></td>		<td align="left"><input type=text readonly name=Talla<?=$i?> class=tbox size=5 required></td>
