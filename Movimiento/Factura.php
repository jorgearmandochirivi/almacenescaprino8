...
if ($permisos[0] >= 2) {
	...
	switch (nvl($action)) {
		...
		case "insertcliente":
			...
			$_POST['Gustos'] = isset($_POST['Gustos']) && is_array($_POST['Gustos']) ? implode(",", $_POST['Gustos']) : '';
			$_POST['Hobbies'] = isset($_POST['Hobbies']) && is_array($_POST['Hobbies']) ? implode(",", $_POST['Hobbies']) : '';
			$_POST['Deportes'] = isset($_POST['Deportes']) && is_array($_POST['Deportes']) ? implode(",", $_POST['Deportes']) : '';
			$_POST['Musica'] = isset($_POST['Musica']) && is_array($_POST['Musica']) ? implode(",", $_POST['Musica']) : '';
			$frm = vars_LOG($_POST);
			...
			for ($i = 1; $i < 10; $i++) {
				if (isset($arrayopciones[$i]) && is_array($arrayopciones[$i])) {
		...
		case "updatecliente":
			...
			if (!empty($_POST["Ano"]) && !empty($_POST["Mes"])) {
				...
				if (
					$frm["NombreAnt"] != $frm["Nombre"] || $frm["ApellidoAnt"] != $frm["Apellido"] ||
			...
			<tr>
				<td>
					<table width=100% border=0 cellspacing=1 cellpadding=1 class="texto forumline">
						...
						?>
							<tr>
								<td width="40%" class="col1">Numero de Documento ( <span class="rojo">*</span> )</td>
								<td class=col2><input type=text size=25 class="tbox obligatorio cedula_guarda" title="Numero de documento" name=Cedula id=Cedula value="<?= $r->Cedula ?>" <?php if (!empty($r->IDCliente)) { ?> readonly <?php  } ?>>
									<input type="hidden" name="ClubSuavidad" id="ClubSuavidad" value="S" />
								</td>
							</tr>
							<tr>
								<td width="40%" class="col1">Pasaporte</td>
								<td class=col2>
							...
							<tr>
								<td class="col1" width="40%"> Nombre o Raz&oacute;n Social ( <span class="rojo">*</span> )</td>
								<td class="col2"><input type=text size=25 class="tbox obligatorio" title="Nombre" name=Nombre id=Nombre value="<?= $r->Nombre ?>" <?php if (!empty($r->IDCliente) && !empty($r->Nombre)) { ?> readonly <?php  } ?>> </td>
							</tr>
							<tr>
								<td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td>
								<td class="col2"><input type=text size=25 class="tbox obligatorio" title="Apellido" name=Apellido id=Apellidos value="<?= $r->Apellido ?>" <?php if (!empty($r->IDCliente) && !empty($r->Apellido)) { ?> readonly <?php  } ?>> </td>
							</tr>
							<tr>
							...
							<tr>
								<td width="40%" class="col1"> Telefono ( <span class="rojo">*</span> )</td>
								<td class="col2"><input type=number size=25 class="tbox obligatorio" title="Telefono" name=Telefono id=Telefono value="<?= $r->Telefono ?>" <?php if (!empty($r->IDCliente) && !empty($r->Telefono)) { ?> readonly <?php  } ?>> </td>
							</tr>
							...
							<tr>
								...
								<td class="col2"><?php echo formpopup("Ciudad", "Descripcion", "Descripcion", "IDCiudad", $r->IDCiudad, "input\" id=\"IDCiudad", "", $bloqueo); ?></td>
							</tr>
							<tr>
								<td width="40%" class="col1">Direcci&oacute;n</td>
								<td class="col2"><input type=text size=25 class="tbox" name=Direccion id=Direccion value="<?= $r->Direccion ?>" <?php if (!empty($r->IDCliente) && !empty($r->Direccion)) { ?> readonly <?php  } ?>> </td>
							</tr>
							<!--
                            <tr >
							...
							<tr>
								...
								<td class="col2"><?php echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ", "Nombre", "Apellidos", "IDEmpleado", $r->IDEmpleado, "input\" id=\"Empleado", "", $bloqueo); ?></td>
							</tr>
							...
							<td colspan="2">
								...
								<div class="noFidelizar hide">
									<table width="100%" border=0 cellspacing=1 cellpadding=1 class="texto forumline">
										...
										<tr>
											<td width="40%" class="col1">N&uacute;mero Documento( <span class="rojo">*</span> )</td>
											<td class=col2><input type=text size=25 class="tbox cedula_no_club" title="Cedula" value="<?= $cedula ?>" name="cedula_no_club" id="cedula_no_club"></td>
										</tr>
										<tr>
											<td class="col1" width="40%"> Nombre( <span class="rojo">*</span> )</td>
											<td class="col2"><input type=text size=25 class="tbox nombre_no_club" title="Nombre" name="nombre_no_club" id="nombre_no_club" <?= $readonly ?> value="<?= $r->Nombre ?>"> </td>
										</tr>
										<tr>
											<td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td>
											<td class="col2"><input type=text size=25 class="tbox apellido_no_club" title="Apellidos" name="apellido_no_club" id="apellido_no_club" <?= $readonly ?> value="<?= $r->Apellido ?>"> </td>
										</tr>
										<tr>
										...
										<tr>
											<td width="40%" class="col1">Ciudad</td>
											<td class="col2"><?php echo formpopup("Ciudad", "Descripcion", "Descripcion", "IDCiudad", $ciudad_cliente, "input\" id=\"IDCiudad"); ?></td>
										</tr>
										<tr>
											<td width="40%" class="col1">Empleado:</td>
											<td class="col2"><?php echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ", "Nombre", "Apellidos", "IDEmpleado", $r->IDEmpleado, "input\" id=\"Empleado"); ?></td>
										</tr>
									</table>
								...
								<div class="siFidelizar hide">
									<table width="100%" border=0 cellspacing=1 cellpadding=1 class="texto forumline">
										...
										<tr>
											<td width="40%" class="col1">Numero de Documento ( <span class="rojo">*</span> )</td>
											<td class=col2><input type=text title="Numero de Documento" size=25 class="tbox obligatorio cedula_guarda" value="<?= $cedula ?>" name=Cedula id=Cedula> </td>
										</tr>

										<tr>
											<td class="col1" width="40%"> Nombre ( <span class="rojo">*</span> )</td>
											<td class="col2"><input type=text size=25 class="tbox obligatorio" title="Nombre" name=Nombre id=Nombre <?= $readonly ?> value="<?= $r->Nombre ?>"> </td>
										</tr>
										<tr>
											<td width="40%" class="col1"> Apellidos ( <span class="rojo">*</span> )</td>
											<td class="col2"><input type=text size=25 class="tbox obligatorio" title="Apellido" name=Apellido id=Apellidos <?= $readonly ?> value="<?= $r->Apellido ?>"> </td>
										</tr>
										<tr>
											<td class="col1" width="40%">G&eacute;nero ( <span class="rojo">*</span> )</td>
										...
										<tr>
											<td width="40%" class="col1"> Telefono ( <span class="rojo">*</span> )</td>
											<td class="col2"><input type=number size=25 class="tbox obligatorio" title="Telefono" name=Telefono id=Telefono value="<?= $r->Telefono ?>"> </td>
										</tr>
										...
										<tr>
											<td width="40%" class="col1">Empleado</td>
											<td class="col2"><?php echo formpopup("Empleado WHERE IDPuntoVenta = '$IDPuntoVenta' ", "Nombre", "Apellidos", "IDEmpleado", $r->IDIDEmpleado, "input\" id=\"IDEmpleadoFideliza"); ?></td>
										</tr>
										<tr>
											<td width="40%" class="col1">Medio por el que lleg&oacute;:</td>
											<td class="col2"><?php
										...
										<table style="display: none" id="TablaSuavidad">
											<tr>
												<td width="40%" class="col1">Desea ser parte del club de la suavidad? </td>
												<td class="col2">
									...
									<div id="otrosdatosfactura" style="display:none">
										<table width=100% border=0 cellspacing=1 cellpadding=1 class="texto forumline">
											...
											<tr>
												<td width="40%" class="col1">Direcci&oacute;n</td>
												<td class="col2"><input type=text size=25 class="tbox" title="Direccion" name=Direccion id=Direccion value="<?= $r->Direccion ?>"> </td>
											</tr>
...
function print_form($id, $newmode, $title, $submit_caption, $frm = "")
{
	...
	// Inicializar $frm como array si viene vacío (compatibilidad PHP 8+)
	if (!is_array($frm)) {
		$frm = array();
	}
												...
												<table class=rowtable width="100%">
													...
													<tr>
														...
														<td class=col2 colspan="3"><input type="text" class="tbox" name="FechaFactura" size="19" value='<?= fecha() . " " . hora() ?>' readonly>
															...
															<input type="hidden" value="<?= $IDPuntoVenta ?>" id="IDPuntoVenta" name="IDPuntoVenta">
														</td>
													</tr>
													<!--
													<tr>
														<td class=col1>Observaciones</td>
														<td class=col2 colspan="3"><textarea class="tareabox" name="Observaciones" rows="4" cols="64"></textarea></td>
													</tr>
                        -->
													<tr>
                        ...
                        -->
													...
													<tr>
														...
														<td class=col2 colspan="3">
															...
															<input type="text" class="tbox" name="NumeroPagare" id="NumeroPagare" value="<?php echo $frm['NumeroPagare'] ?? '' ?>">
														</td>
													</tr>
													<tr>
																		...
																		<tr>
																			<td>
																				<?php if ($r_bono["Disponible"] == "S") { ?>
																					<input type="radio" class="IDBonoIva" name="IDBonoIva[]" id="IDBonoIva<?php echo $r_bono['IDBonoIva'] ?>" Valorbono=<?php echo $r_bono["Valor"]; ?> value="<?php echo $r_bono['IDBonoIva'] ?>" <?php if (in_array($r_bono['IDBonoIva'], $frm['IDBonoIva'])):  echo "onclick='this.checked=true'";
																																																																						echo "checked";
																																																																					else: if ($submit_caption == "Confirmar Factura"): echo "onclick='this.checked=false'";
																																																																						endif;
																																																																					endif;  ?> />
										...
										<tr>
											...
											<td class=col2><input type="text" readonly name="SumaBono" id="SumaBono" value="<?php echo empty($frm['SumaBono'] ?? '') ? '0' : $frm['SumaBono']; ?>" class="tbox" size="15" />
												...
												<input type="hidden" name="SobranteBono" id="SobranteBono" value="<?php echo (($frm['SobranteBono'] ?? 0) != 0) ? $frm['SobranteBono'] : '0'; ?>" />
										...
										<tr>
											...
											<td class=col1></td>
											<td class="col2">
												<div align="right"> Agregar valor envio </div>
											</td>
											<td class="col2">
									...
									<?php
									$clase_bloqua_boton = "";
									if ($submit_caption == "Confirmar Factura"):
...
<?php
} // END function print_form($id,$newmode,$title,$submit_caption,$frm)
?>
