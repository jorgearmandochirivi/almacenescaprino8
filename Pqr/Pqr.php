...
<br>
<form name="frm" action="<?=$PHP_SELF?>" method="post"  enctype="multipart/form-data" <?php if($newmode!="delete"){?>onsubmit="return EvaluaReg2(this,Check);disable(this);"<? } ?>>
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
          ...
          <tr class=row2>
            ...
            <td><? echo get_field("PqrSolucion","Nombre","IDPqrSolucion",$r_comentario->IDPqrSolucion) ?></td>
            <td>Creado por</td>
          ...
          <tr class=row2>
            <td colspan="4"><textarea name="Descripcion" class="" title="Descripcion" id="Descripcion" cols="80" rows="8" <?php if($newmode=="update") echo "readonly"; ?> required ><? echo $r->Descripcion; ?></textarea></td>
          </tr>
