			...
			<td class='mainbg'>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td class="navpic" align="center" nowrap>Ref </td>
						<td class="navpic" align="center" nowrap>Vr. Unit.</td>
					...
					<tr>
									...
									<td class="<?=$class?>" align="right" nowrap>
										<?php
												...
												if( $valor['DescuentoFactura'] == 0 && (int)$descuento_bono<=0 )
												{
													...
													echo number_format( $pago ,0); $Pago += $pago;
												}
												else
												{
						...
						echo number_format( $valoriva,0 );$ValorIVA += $valoriva; ?>
