...
?>
	...
	<table width="100%">
			...
			<table width='100%' align='left' border="0" cellspacing="0" cellpadding="2" class="bordertable">
				<form action="./" name="frmPuntoVenta" method="post" >
						<tr>
							...
							<td  align='left' valign='middle' class="nav"><img src='images/house.png' border='0'  alt=''>
								Estado
							...
							<td align="left" valign="middle" class="nav">
	                                 <input type="hidden" name="IDPuntoVenta" id="IDPuntoVenta" value="<?php echo $IDPuntoVenta; ?>">
                                 <input type="hidden" name="action" value="view">
                                 <input type="hidden" name="mod" value="reportecredito"><input type="hidden" name="action" value="view"></td>
							<td align="left" valign="middle" class="nav">
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <br>
               ...
               <a href="admin/exportar/exportcredito.php?IDPuntoVenta=<?=$IDPuntoVenta?>&FechaDesde=<?=$FechaDesde?>&FechaHasta=<?=$FechaHasta?>">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						<tr>
										...
										<td class="titlemedium" align="center" nowrap>Nro Pagare</td>
							...
							<td class="titlemedium" align="center" nowrap>Vr Total</td>
							<td class="titlemedium" align="center" nowrap>C. Abonadas</td>
										<td class="titlemedium" align="center" nowrap>C. Pdtes</td>
										<td class="titlemedium" align="center" nowrap>Valor Pendiente</td>
                        ...
                        <tr>
						  ...
						  <td class="<?=$class?>" align="center" nowrap>&nbsp;</td>
						  <td class="<?=$class?>" align="center" nowrap><strong>TOTAL PENDIENTE</strong></td>
						  <td class="<?=$class?>" align="center" nowrap>$<?php echo number_format($TotalPendiente,'0',',','.'); ?></td>
						  <td class="<?=$class?>" align="center" nowrap>&nbsp;</td>
						  <td class="<?=$class?>" align="center" nowrap >&nbsp;</td>
						  <td class="<?=$class?>" align="center" nowrap><strong>TOTAL CARTERA</strong></td>
								  <td class="<?=$class?>" align="center" nowrap><strong>$<?php echo number_format($valor_total_cartera,'0',',','.'); ?></strong></td>
					  </tr>
