									...
									{ 
										...
										?>
											...
											<tr>
												...
												<td class="<?=$class?>" align="right" nowrap><?echo number_format( $ValorReteFuente = ( $r_factura->Valor/ ( 1 + $IVA ) )  * $ReteFuente , 2 ); $valorretefuente += $ValorReteFuente; ?></td>
												<td class="<?=$class?>" align="right" nowrap><?echo number_format( $r_factura->Valor - $comision - $ValorReteFuente, 2 ); $valoringreso +=  $r_factura->Valor - $comision - $ValorReteFuente?></td>
											</tr>
