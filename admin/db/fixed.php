	...
	<tr>
			<td>
				...
				var Check2 = new Array("Importar");
					...
					<form name="frmInv" action="<? echo $PHP_SELF ?>" method="post" enctype="multipart/form-data" onSubmit="return EvaluaReg(this,Check2)">
						...
						<tr class=row2>
							...
							<td><select name="IDPuntoVenta" class="input">
									<? 								$sql_puntoventa = "SELECT * FROM PuntoVenta Where Publicar = 'S'";
					...
					<!--
					<form name="frmfacturaelectronica" action="<? echo $PHP_SELF ?>" method="post" enctype="multipart/form-data" >
						<tr class=row2><td colspan=2><%=Mensaje_Info("Cambiar a Factura Electr&oacute;nica")%></td>
						</tr>
						<tr class=row2>
							<td class=row2>
								<div align="left">
					...
					<form name="frmVerificaCambios" action="<? echo $PHP_SELF ?>" method="post" enctype="multipart/form-data" >
						<tr class=row2>
							<td colspan="2"><%=Mensaje_Info("Borrar Cambios / Recuerde Borrar Primero el excedente generado")%></td>
						</tr>
						<tr class=row2>
							<td class=row2>
								<div align="left">
					...
					<form name="frmVerificaFacturaBonos" action="<? echo $PHP_SELF ?>" method="post" enctype="multipart/form-data" >
						<tr class=row2>
							<td colspan="2"><%=Mensaje_Info("Borrar Redimir Bonos / Recuerde Borrar Primero el excedente generado")%></td>
						</tr>
						<tr class=row2>
							<td class=row2>
								<div align="left">
