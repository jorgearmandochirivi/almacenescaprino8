...
<input type=hidden name=IDCuero id=IDCuero value="<?=$r->IDCuero ?>"><input type=submit name=submit value="<? echo $submit_caption ?>" class=submit>
			</td>
				</tr>
			</table>
		</td>
...
<td nowrap class=row1><? echo $r->IDCuero ?></td> <td nowrap class=row1><? echo $r->Descripcion ?></td>
