...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td>Numero de Puntos</td><td><input type="text" class="input" name="PuntosNecesarios" size="19" value="<?=$r->PuntosNecesarios?>" >
								
							</td>
			</tr>
			<tr class=row2>
			<td>Valor</td><td><input type="text" class="input" name="Valor" size="19" value="<?=$r->Valor?>" >
								
							</td>
			</tr>		
			
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDValorPuntos value="<?=$r->IDValorPuntos ?>">    <input type=hidden name=ID value="<?php echo $r->$Key ?>">
