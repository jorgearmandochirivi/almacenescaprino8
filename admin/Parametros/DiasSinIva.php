...
<td><input type="number" name="TopeUnidadSinIva" id="TopeUnidadSinIva" value="<?=$r->TopeUnidadSinIva?>" ></td>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDDiaSinIva value="<?=$r->IDDiaSinIva ?>">    <input type=hidden name=ID value="<? echo $r->$Key ?>">
...
<tr>
	...
	&nbsp;<a href='<? echo "?mod=$MOD&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
						...
						<td nowrap class=row1><? echo $r->TopeDiaSinIva ?></td>
						<td nowrap class=row1><? echo $r->TopeUnidadSinIva ?></td>
