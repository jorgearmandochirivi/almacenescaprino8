	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td>Fecha</td><td><input type="text" class="input" name="Fecha" size="19" value="<?php echo $r->Fecha?>" readonly>
						...
						<tr class=row2>
			<td>Valor Tope</td><td><input type="number" name="TopeDiaSinIva" id="TopeDiaSinIva" value="<?php echo $r->TopeDiaSinIva?>" ></td>

</tr>
<tr>	
<td>Unidades Tope</td>
<td><input type="number" name="TopeUnidadSinIva" id="TopeUnidadSinIva" value="<?php echo $r->TopeUnidadSinIva?>" ></td>
			</tr>
			
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDDiaSinIva value="<?php echo $r->IDDiaSinIva ?>">    <input type=hidden name=ID value="<?php echo $r->$Key ?>">
