...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td>Fecha</td><td><input type="text" class="input" name="Fecha" size="19" value="<?=$r->Fecha?>" readonly>
						...
						<tr class=row2>
			<td>Valor Tope</td><td><input type="number" name="TopeDiaSinIva" id="TopeDiaSinIva" value="<?=$r->TopeDiaSinIva?>" ></td>

</tr>
<tr>	
<td>Unidades Tope</td>
<td><input type="number" name="TopeUnidadSinIva" id="TopeUnidadSinIva" value="<?=$r->TopeUnidadSinIva?>" ></td>
			</tr>
			
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDDiaSinIva value="<?=$r->IDDiaSinIva ?>">    <input type=hidden name=ID value="<?php echo $r->$Key ?>">
...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href='<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Dia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Valor Tope</a><a style="color: #3A4F6C;text-decoration: none" href='<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Dia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>&nbsp;<?php if($_GET['order_by']=="Dia")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a></td>
						<td class=rowform nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href='<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Dia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Unidades Tope</a><a style="color: #3A4F6C;text-decoration: none" href='<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Dia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>&nbsp;<?php if($_GET['order_by']=="Dia")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a></td>
...
<tr>
	...
	&nbsp;<a href='<?php echo "?mod=$MOD&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
						...
						<td nowrap class=row1><?php echo $r->TopeDiaSinIva ?></td>
						<td nowrap class=row1><?php echo $r->TopeUnidadSinIva ?></td>
