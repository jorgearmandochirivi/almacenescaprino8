...
$TitleMod ="DetalleMoviento";

$Table = "DetalleMoviento";
$TableJoin = "DetalleMoviento";
...
?>
<script>
var Check = new Array('IDDetalleMovimiento','IDMovimiento','IDReferencia','Cantidad','Publicar','UsuarioTrCr','FechaTrCr','UsuarioTrEd','FechaTrEd');
</script>
...
<tr class=row2>
			<td> IDDetalleMovimiento </td><td><input type=text size=25 class=input  readonly name=IDDetalleMovimiento id=IDDetalleMovimiento value="<?=$r->IDDetalleMovimiento ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDMovimiento </td><td><input type=text size=25 class=input   name=IDMovimiento id=IDMovimiento value="<?=$r->IDMovimiento ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDDetalleMovimiento&nbsp;<% if($_GET['order_by']=="IDDetalleMovimiento"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDMovimiento&nbsp;<% if($_GET['order_by']=="IDMovimiento"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
...
<td nowrap class=row1><? echo $r->IDDetalleMovimiento ?></td> <td nowrap class=row1><? echo $r->IDMovimiento ?></td> <td nowrap class=row1><? echo $r->IDReferencia ?></td> <td nowrap class=row1><? echo $r->Cantidad ?></td>
