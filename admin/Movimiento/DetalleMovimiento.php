...
<tr class=row2>
			<td> IDDetalleMovimiento </td><td><input type=text size=25 class=input  readonly name=IDDetalleMovimiento id=IDDetalleMovimiento value="<?php echo $r->IDDetalleMovimiento ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDMovimiento </td><td><input type=text size=25 class=input   name=IDMovimiento id=IDMovimiento value="<?php echo $r->IDMovimiento ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDDetalleMovimiento&nbsp;<?php  if($_GET['order_by']=="IDDetalleMovimiento"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDMovimiento&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDMovimiento&nbsp;<?php  if($_GET['order_by']=="IDMovimiento"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDDetalleMovimiento ?></td> <td nowrap class=row1><?php echo $r->IDMovimiento ?></td> <td nowrap class=row1><?php echo $r->IDReferencia ?></td> <td nowrap class=row1><?php echo $r->Cantidad ?></td>
