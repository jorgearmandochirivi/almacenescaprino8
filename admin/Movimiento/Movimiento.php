							...
							<td class="row1" nowrap>
								<table width=100% cellspacing="1" cellpadding="1" bgcolor=#ffffff>
									<tr>
										...
										<td class=row1>
											<input type="text" class="input" name="NumeroOrden" readonly size="24" value="<?php echo $r->NumeroOrden?>">
										</td>
									</tr>
									<tr>
										<td class=row1>Punto de Venta</td>
										<td class=row1><input type="text" class="input" name="PuntoVenta" readonly size="24" value="<?php echo get_field("PuntoVenta","Nombre","IDPuntoVenta",$r->IDPuntoVenta)?>"><input type="hidden" name="IDPuntoVenta" value="<?php echo $r->IDPuntoVenta;?>"></td>
										<td class=row1>Remisi&oacute;n</td>
										<td class=row1><input type="text" class="input" name="Remision" size="24" value="<?php echo $r->Remision?>"></td>
									</tr>
									<tr>
										<td class=row1>Fecha Remisi&oacute;n</td>
										<td class=row1>
											<input type="text" class="input" name="FechaRemision" size="15" value="<?php echo fecha()." ".hora()?>" readonly>
									...
									<tr>
										<td class=row1 colspan="4" align="center">
											...
											<input type="hidden" name="IDOrdenCompra" value="<?php echo $r->IDOrdenCompra?>"><input type="hidden" name="IDEmpleado" value="<?php if($newmode == "insert") echo $ID_Usuario; else echo  $r->IDEmpleado;?>">
			...
			<td>
				<table width=100% border=0 cellspacing=1 cellpadding=0>
					...
					<td align=center class=rowform valign=middle nowrap bgcolor=#DBEAF5>Crear</td>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=NumeroOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Numero de Orden</a><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=NumeroOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>&nbsp;<?php  if($_GET['order_by']=="NumeroOrden"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
					<td class=rowform nowrap bgcolor=#DBEAF5><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=NumeroOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Fecha de Orden</a><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=FechaOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">&nbsp;<?php  if($_GET['order_by']=="FechaOrden"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
						<td class=rowform nowrap bgcolor=#DBEAF5><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDEstadoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Estado Pedido</a><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDEstadoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'><?php  if($_GET['order_by']=="IDEstadoPedido"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
					</tr>
