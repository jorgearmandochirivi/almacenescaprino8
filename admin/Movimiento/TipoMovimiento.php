...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=300 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td>Nombre</td><td><input type=text size=25 class=input   name=NombreMovimiento id=NombreMovimiento value="<?php echo $r->NombreMovimiento ?>"> </td>
			</tr>
						<tr class=row2>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDTipoMovimiento id=IDTipoMovimiento value="<?php echo $r->IDTipoMovimiento ?>"><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
...
<tr>
	...
	&nbsp;<a href='<?php echo "?mod=$MOD&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
						...
						<td nowrap class=row1><?php echo $r->NombreMovimiento ?></td>
