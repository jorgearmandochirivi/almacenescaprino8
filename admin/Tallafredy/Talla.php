...
<tr class=row2>
			<td> IDTalla </td><td><input type=text size=25 class=input  readonly name=IDTalla id=IDTalla value="<?php echo $r->IDTalla ?>"> </td>
			</tr>
			<tr class=row2>
...
<table width=100% border=0 cellspacing=1 cellpadding=0>
	<tr>
		...
		<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTalla&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDTalla&nbsp;<?php  if($_GET['order_by']=="IDTalla"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
