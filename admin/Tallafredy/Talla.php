...
?>
<script>
var Check = new Array('Descripcion','IDTipoTalla','Publicar');
</script>
...
<tr class=row2>
			<td> IDTalla </td><td><input type=text size=25 class=input  readonly name=IDTalla id=IDTalla value="<?=$r->IDTalla ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDTipoTalla </td><td><? echo formpopup("TipoTalla","Descripcion","Descripcion","IDTipoTalla",$r->IDTipoTalla,"input\" id=\"Tipo Talla"); ?> </td>
			</tr>
			<tr class=row2>
...
<table width=100% border=0 cellspacing=1 cellpadding=0>
	<tr>
		...
		<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTalla&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDTalla&nbsp;<% if($_GET['order_by']=="IDTalla"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
	...
	<tr>
		...
		<td nowrap class=row1><? echo $r->IDTalla ?></td> <td nowrap class=row1><? echo $r->Descripcion ?></td> 
		...
		<tr>
			<td class="rowform" align="center" colspan=8>
				<select name="field" id="Buscar por" class="popup">
					...
					<option value="TipoTalla.Descripcion">Tipo Talla</option>
				...
				<input type="hidden" name="tjoin" value="TipoTalla">
