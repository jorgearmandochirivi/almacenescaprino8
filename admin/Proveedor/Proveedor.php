...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href='<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Nombre&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Codigo<?php if($_GET['order_by']=="Nombre")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a></td>
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDCiudad&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Ciudad&nbsp;<?php if($_GET['order_by']=="IDCiudad")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Direccion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Direccion&nbsp;<?php if($_GET['order_by']=="Direccion")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
