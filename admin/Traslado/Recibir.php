			...
			<td width="100%">
				<table width=100% border=0 cellspacing=1 cellpadding=0>
					<tr>
						...
						<td class="titlemedium" nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDPuntoVentaDestino&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Almacen de Destino&nbsp;<?php  if($_GET['order_by']=="IDPuntoVentaDestino"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
						...
						<td class="titlemedium" nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDEstadoTraslado&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Estado&nbsp;<?php  if($_GET['order_by']=="IDEstadoTraslado"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
					...
					<tr>
						...
						<td nowrap class="<?php echo $class?>"><?php echo $r->IDTraslado?></td>
						...
						<td nowrap class="<?php echo $class?>"><?php if ($r->FechaTrEd!="0000-00-00 00:00:00") echo formatofecha(substr($r->FechaTrEd,0,10))." ".substr($r->FechaTrEd,10) ?></td>
					</tr>
					<?php } // END for
							?>
					<tr>
