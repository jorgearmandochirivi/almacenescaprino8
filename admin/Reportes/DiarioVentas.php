				      ...
				      <td class='mainbg'><table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						?>
				                <tr>
				                  ...
				                  <td class="<?=$class?>" align="right" nowrap><?=number_format( $r_credito->ValorTotal , 2); 
						...
						?>
				                <tr>
				                  ...
				                  <td class="titlemedium" align="right" nowrap><?=number_format( $ValorEfec, 2 )?></td>
			                    </tr>
			                  </td>
			              </tr>
				                ...
				                <tr>
								  ...
								  <td class="titlemedium" align="right" nowrap></td>
				                  <td class="titlemedium" align="right" nowrap>Total</td>
				                  <td class="titlemedium" align="right" nowrap><?=number_format( $ValorTrans, 2 )?></td>
			                    </tr>
