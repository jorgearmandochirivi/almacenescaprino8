			...
			<table width='100%' align='left' border="0" cellspacing="0" cellpadding="2" class="bordertable">
				<form action="./" name="frmPuntoVenta" method="post" name="Moviles">
						<tr>
							...
							?>
								</select> <input type="hidden" name="mod" value="Reportes"><input type="hidden" name="action" value="view"></td>
				...
				<table width="100%" border="0" align='center' cellspacing="1" cellpadding="0" bgcolor="#345487">
				  <form name="frm" action="<?php echo $PHP_SELF?>" method="post" onSubmit="return Evalua(document.frm)">
					...
					$sql_facturas = " SELECT F.NumeroFactura,F.IDFactura, F.FechaFactura, F.ValorTotal, F.IDCliente, R.Numero, DF.ValorU,DF.PrecioU, DF.Cantidad,DF.DescuentoRef,DF.DescuentoPar, P.Descuento, F.Descuento as DescuentoFactura, F.ValorBono as ValorBono,
										...
										AND PVR.IDReferencia = R.IDReferencia AND R.IDPrecio = P.IDPrecio AND R.Reportes <> 'N' Order by NumeroFactura ASC,DF.ValorU DESC";
				...
				?>
				    <tr>
				      <td class='mainbg'><table width="100%" border="0" cellspacing="1" cellpadding="1">
				        ...
				        <tr>
				          ...
				          <td class="<?php echo $class?>" align="center" nowrap><?php 
				           ...
				           <td class="<?php echo $class?>" align="right" nowrap>
										...
										$SumaUnitario+=$ElValorUnitarioExc;
				          ...
				          <td class="<?php echo $class?>" align="right" nowrap>&nbsp;
				            ...
				            <?php
										...
										$TotalFactura = $valor[ValorTotal] ;
												...
												//echo "DESCUU " . $valor['DescuentoPar'];	
						  ...
						  <?php
						 	$TotaleDescuentoPar+=$valor['DescuentoPar'];
						 	echo  $valor['DescuentoPar'];						 
						 ?></td>
				          <td class="<?php echo $class?>" align="right" nowrap>
	                          <?php
							  							if((int)$pago<=0){
						...
						?>
				        <tr>
				          <td class="titlemedium" colspan="0" align="right" nowrap>TOTALES</td>
						  <td class="titlemedium" align="center" nowrap></td>
						  <td class="titlemedium" align="center" nowrap></td>
						  <td class="titlemedium" align="center" nowrap><?php echo number_format( $SumaUnitario ,2); ?></td>
				          ...
				          <td class="titlemedium" align="center" nowrap><?php echo number_format( $TotalBono , 2);  ?></td>
				          <td class="titlemedium" align="right" nowrap><?php echo number_format( $TotaleDescuentoPar , 2);  ?></td>
						...
						?>
				                <tr>
								  ...
								  <td class="<?php echo $class?>" align="right" nowrap><?php echo $r_credito->MedioPago?></td>
				                  <td class="<?php echo $class?>" align="right" nowrap><?php echo number_format( $r_credito->ValorTotal , 2); 
								  $ValorTotal += $r_credito->ValorTotal;
								  $ValorEfec += $r_credito->ValorTotal;
								  ?></td>
			                    </tr>
				                <?php
						}//ebd while
						?>
				                <tr>
				                  ...
				                  <td class="titlemedium" align="right" nowrap><?php echo number_format( $ValorEfec, 2 )?></td>
			                    </tr>
			                  </td>
			              </tr>
								...
								?>
										...
										<td class="<?php echo $class?>" align="right" nowrap><?php echo number_format( $r_credito->ValorTotal , 2); 
										$ValorTotal += $r_credito->ValorTotal;
										$ValorTrans += $r_credito->ValorTotal;
										?></td>
										</tr>
										<?php
								}//ebd while
				                ...
				                <tr>
								  ...
								  <td class="titlemedium" align="right" nowrap></td>
				                  <td class="titlemedium" align="right" nowrap>Total</td>
				                  <td class="titlemedium" align="right" nowrap><?php echo number_format( $ValorTrans, 2 )?></td>
			                    </tr>
								...
								<tr>
				                  ...
				                  <td class="titlemedium" align="right" nowrap></td>
								  <td class="titlemedium" align="right" nowrap></td>
				                  <td class="titlemedium" align="right" nowrap>GRAN TOTAL Total</td>
