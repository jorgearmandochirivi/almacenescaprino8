<?php
	...
	echo $sql_facturas = " SELECT F.NumeroFactura,F.IDFactura, F.FechaFactura, F.ValorTotal, R.Numero, DF.ValorU,DF.PrecioU, DF.Cantidad,DF.DescuentoRef,DF.DescuentoPar, P.Descuento, F.Descuento as DescuentoFactura,
	...
	WHERE DATE_FORMAT( F.FechaFactura,'%Y-%c-%d' ) BETWEEN ( DATE_FORMAT('$FechaInicio','%Y-%c-%d' )   ) 
	...
	AND PVR.IDReferencia = R.IDReferencia AND R.IDPrecio = P.IDPrecio LIMIT 10";
