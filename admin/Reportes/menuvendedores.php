	...
	<table cellspacing="0" cellpadding="2" border="0" align="center" width="100%" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td width="85%" align="left" valign="middle" class="nav" style="border-bottom:1px solid #4C77B6">
				<a href="./?mod=VentasVendedor">Ventas - Vendedor</a> |
        <a href="./?mod=RotacionVendedor">Rotacion - Vendedor</a> |
				<a href="./?mod=VentasVendedorIndividual">Ventas Vendedor Individual</a> |
			</td>
		</tr>
		</table>
</body>
