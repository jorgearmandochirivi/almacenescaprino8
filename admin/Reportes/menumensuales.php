	...
	<table cellspacing="0" cellpadding="2" border="0" align="center" width="100%" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td width="85%" align="left" valign="middle" class="nav" style="border-bottom:1px solid #4C77B6">
				<a href="./?mod=MensualNetas">Mensual Netas</a> |
				<a href="./?mod=NetasAlmacenes">Ventas Almacenes</a> | 
				<a href="./?mod=TotalesAlmacen">Consolidado Almacenes</a> | 
				<a href="./?mod=ExportaMensual">Exportar Archivo Plano</a> | 
                <a href="./?mod=MensualCreditos">Mensual Cr&eacute;ditos</a> |
				<!--<a href="./?mod=TotalesAlmacen">Consolidado Almacenes</a> |-->
			</td>
		</tr>
		</table>
