	...
	<td valign="top" height="93%">
							...
							<td align="left" valign="top" bgcolor="white" width="118"><i><img src="images/logosimtools.gif" alt="" height="38" width="118" border="0"><br>
								...
								<table width=110 >
									...
									<tr height="18">
										<td height="18" background="images/botongral.gif">
											<div align="center">
												<a href="?mod=Fidelizacion" class="menuppal">Fidelizaci�n</a></div>
										</td>
									</tr>
									<tr height="18">
										<td height="18" background="images/botongral.gif">
	  	...
	  	switch(nvl($mod)){
			...
			case "RotacionInventarioGral" :
	  		...
	  		/******************* INICIO FIDELIZACION ******************/
	  		case "Fidelizacion" :
	  			include("Pregunta/menu.html");
				include("Pregunta/Pregunta.php");
	  		break;
	  		case "Opciones" :
	  			include("Pregunta/menu.html");
				include("Pregunta/Opcion.php");
	  		break;
	  		case "FidParametros" :
	  			include("Pregunta/menu.html");
				include("Pregunta/Parametros.php");
	  		break;
			case "ReporteFid" :
				include("Pregunta/menu.html");
				include("Pregunta/ReporteFid.php");
			break;
