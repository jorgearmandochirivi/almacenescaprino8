...
if($permisos[0] >= 2)
{
		switch (nvl($action)) {
			...
			case "autorizacambio":
				$sql_inserta_aut = "Insert Into AutorizacionCambio (IDFactura, IDPuntoVenta, FechaAutorizacion, AutorizadoPor)
			...
			case "list" :
				...
				if(!empty($_GET["limit1"]) && !empty($_GET["limit2"])){
						$cond_fecha= " and FechaFactura>= '".$_GET["limit1"]." 00:00:00' and FechaFactura<= '".$_GET["limit2"]." 23:59:59'";
						$_GET["limit1"]=$_GET["limit1"]." 00:00:00";
						$_GET["limit2"]=$_GET["limit2"]." 23:59:59";
				}

				if(!empty($_GET["FacturaElec"])){
					if($_GET["FacturaElec"]=="N")
						$buscar_elec="";
					else
						$buscar_elec="S";
					

					$cond_fecha.= " and FacturaElectronica = '".$buscar_elec."' " ;
					$_GET["FacturaElectronica"] = $buscar_elec;
				}	
				...
				if( $field == "NumeroReferencia" )
				{
					...
					$sql = " SELECT * FROM Referencia R, PuntoVentaReferencia PR, CodificacionEspecifica CE, DetalleFactura DF, Factura F
								...
								AND DF.IDPuntoVenta = F.IDPuntoVenta ".$cond_fecha."
								GROUP BY F.IDFactura
								ORDER BY F.FechaFactura DESC " ;

				}//end if
				elseif(!empty($_GET["FacturaElec"])){
					$sql = " SELECT * FROM Referencia R, PuntoVentaReferencia PR, CodificacionEspecifica CE, DetalleFactura DF, Factura F
								WHERE R.IDReferencia = PR.IDReferencia
								AND PR.IDPuntoVentaReferencia = CE.IDPuntoVentaReferencia
								AND CE.IDCodificacionEspecifica = DF.IDCodificacionEspecifica
								AND DF.IDFactura = F.IDFactura
								AND DF.IDPuntoVenta = F.IDPuntoVenta ".$cond_fecha."
...
<table border=1 cellpadding=1 cellspacing=0 bordercolor=#9DAAC6 align=center style="border-collapse: collapse">
	...
	<tr>
		<td>
											...
											<td colspan="4">
												<table class=rowtable>
													...
													<tr>
													  ...
													  <td class=row2><?php if($r->Estado=="ELECTRONICA"){
													...
													<tr>
														...
														<td class=row1><input type="text" class="input" name="FechaFactura" size="24" value='<?php echo $r->FechaFactura?>' readonly> </td>
													...
													<tr>
														<td class=row1>Numero registro</td>
														<td class=row1><input type="text" class="input" name="NumeroRegistro" size="24" value='<?php echo $r->NumeroRegistro?>' readonly> </td>
														<td class=row1><span class="col1"></span></td>
														<td class=row1><span class="col2"></span></td>
													</tr>
													<tr>
														<td class=row1>Payu</td>
														<td class=row1><?php echo $r->NumeroPayu?></td>
														<td class=row1><span class="col1">Adii</span></td>
														<td class=row1><span class="col2">'<?php echo $r->NumeroAddi?></span></td>
													</tr>
													<tr>
													  <td class=row1>Fecha Creacion</td>
													  <td class=row1><?php echo $r->FechaCreacion?></td>
													  <td class=row1>&nbsp;</td>
													  <td class=row1>&nbsp;</td>
												  </tr>
													<tr>
													...
													<tr>
														<td class=rowtable colspan="2"><b>CREDITO</b></td>
														<td class=rowtable></td>
														<td class=rowtable></td>
													</tr>
													<tr>
														<td class=row2>Financiaci&oacute;n</td>
									...
									?>
										...
										<tr bgcolor=#e7ebef>
											<td colspan="4" width="816">
												...
												?>
													<tr bgcolor="#dfe3e7">
														...
														<td align="left" class="<?php echo $class?>"><?php echo get_field("Referencia","Nombre","IDReferencia",get_field("PuntoVentaReferencia","IDReferencia","IDPuntoVentaReferencia",get_field("CodificacionEspecifica","IDPuntoVentaReferencia","IDCodificacionEspecifica",$r_detalle->IDCodificacionEspecifica)))?>
																<?php	
											...
											<tr bgcolor="#dfe3e7">
											  ...
											  <td align="left" class="rowtable" colspan="3"><?php echo number_format($r->ValorIVASinBono)?></td>
											  </tr>
                                             -->
											...
											<tr bgcolor="#dfe3e7">
											  ...
											  <td align="left" class="rowtable" colspan="3"><?php echo number_format($r->ValorTotalSinBono)?></td>
											  </tr>
                                             <?php endif; ?>
											...
											<tr bgcolor="#dfe3e7">
											  ...
											  <td align="left" class="rowtable" colspan="3">-<?php echo number_format($r->ValorBono)?></td>
											  </tr>
                                             <?php endif; ?>
											...
											<tr bgcolor="#dfe3e7">
											  ...
											  <td align="left" class="rowtable" colspan="3"><?php echo number_format((int)$r->ValorTotalSinBono-(int)$r->ValorBono)?></td>
											  </tr>
                                             <?php endif; ?>
											...
											<tr bgcolor="#dfe3e7">
											  ...
											  <td align="left" class="rowtable" colspan="3"><?php echo number_format((int)$r->ValorTotal-(int)$r->ValorIVA)?></td>
											  </tr>
                                            -->
											...
											<tr bgcolor="#dfe3e7">
														...
														<td align="left" class="row2">
															<div align="right">
										      IVA</div></td>
														<td align="left" class="rowtable" colspan="3"><?php echo number_format($r->ValorIVA)?></td>
													</tr>

													<?php if((int)$r->ValorEnvioFactura!="0"){ ?>
													<tr bgcolor="#dfe3e7">
														<td align="left" class="row2"><b><br></b></td>
														<td align="left" class="row2"></td>
														<td align="left" class="row2">
														...
														<td align="left" class="row2">
															<div align="right">
										      Envio seleccionado:</div></td>
														<td align="left" class="rowtable" colspan="3"><?php echo number_format($r->ValorEnvioFactura)?></td>
													</tr>
													<?php  } ?>
											...
											<tr bgcolor="#dfe3e7">
														...
														<td align="left" class="rowtable" colspan="3"><?php echo number_format($r->ValorTotal)?></td>
													</tr>
											...
											?>
												...
												<?php
												if((int)$r->ValorBono>0){
												?>
													<table class="bordertable" border="1" cellspacing="1" cellpadding="1" id=table1 width="100%" bgcolor="#ffffff">
													<tr>
														<td class="navpic" colspan="4" align="left">
															<b>Numero Bono</b>														
														</td>
														<td class="navpic" colspan="4" align="left">
															<b>Bono a nombre de:</b>														
														</td>
													</tr>
													<?php
													$sql_bonos="SELECT BF.IDBonoFidelizacion, C.Nombre, C.Apellido, C.Cedula  FROM BonoFidelizacion BF, Cliente C WHERE BF.IDCliente = C.IDCliente AND BF.IDFactura = '".$r->IDFactura."'";
													$result_bono=db_query($sql_bonos);
													while($row_bono=db_fetch_array($result_bono)){ ?>
													<tr>
														<td class="navpic" colspan="4" align="left">
															<?php echo $row_bono["IDBonoFidelizacion"]; ?>
														</td>
														<td class="navpic" colspan="4" align="left">
															<?php echo $row_bono["Cedula"] . " " . $row_bono["Nombre"]. " " . $row_bono["Apellido"]; ?>
														</td>
													</tr>
													<?php } ?>
													</table>
										...
										?>
												<tr>
													...
													<td class="<?php echo $class?>" align="center">
																...
																<input type="text" class="tbox" name="FechaPago<?php echo $r_cuotas->IDCuota?>" size="19" value='<?php if ($r_cuotas->FechaPago!="0000-00-00 00:00:00") echo $r_cuotas->FechaPago; ?>' readonly>
            ...
            <table class="bordertable" border="0" cellspacing="1" cellpadding="1" id=table1 width="100%" bgcolor="#ffffff">
            	<tr>
            	  <th colspan="2"><a href="?mod=Factura&action=autorizacambio&idfactura=<?php echo $id ?>&id_punto_venta=<?php echo $idpunto?>">Autorizar cambio</a></th>
           	  </tr>
            	<tr>
                	<th>
                    	Fecha Autorizacion
                ...
                <?php
				$sql_autorizacion = "Select * From AutorizacionCambio Where IDFactura = '".$id."' and IDPuntoVenta = '".$idpunto."'";
...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5>Factura Electronica</td>
	...
	<form name="frm" action="./" method="get" onSubmit="return valbuscar(document.frm)">
		<tr>
			<td class="rowform" align="center" colspan=8>
				...
				<br>Factura Electronica
				<input type="radio" name="FacturaElec" value="S">Si generada
				<input type="radio" name="FacturaElec" value="N">No generada
				<br>
				ordenar por
