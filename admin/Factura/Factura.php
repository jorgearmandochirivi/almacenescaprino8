...
<table border=1 cellpadding=1 cellspacing=0 bordercolor=#9DAAC6 align=center style="border-collapse: collapse">
	...
	<tr>
		<td>
											...
											<td colspan="4">
												<table class=rowtable>
													...
													<tr>
														...
														<td class=row1><input type="text" class="input" name="NumeroRegistro" size="24" value='<?=$r->NumeroRegistro?>' readonly> </td>
														<td class=row1><span class="col1"></span></td>
														<td class=row1><span class="col2"></span></td>
													</tr>
													<tr>
														<td class=row1>Payu</td>
														<td class=row1><?=$r->NumeroPayu?></td>
														<td class=row1><span class="col1">Adii</span></td>
														<td class=row1><span class="col2">'<?=$r->NumeroAddi?></span></td>
													</tr>
													<tr>
										...
										<tr bgcolor=#e7ebef>
											<td colspan="4" width="816">
												...
												?>
													<tr bgcolor="#dfe3e7">
														...
														<td align="left" class="<?=$class?>"><?=get_field("Referencia","Nombre","IDReferencia",get_field("PuntoVentaReferencia","IDReferencia","IDPuntoVentaReferencia",get_field("CodificacionEspecifica","IDPuntoVentaReferencia","IDCodificacionEspecifica",$r_detalle->IDCodificacionEspecifica)))?>
																<?php	
											...
											<tr bgcolor="#dfe3e7">
										      ...
										      Envio seleccionado:</div></td>
														<td align="left" class="rowtable" colspan="3"><?=number_format($r->ValorEnvioFactura)?></td>
													</tr>
													<?php  } ?>
            ...
            <table class="bordertable" border="0" cellspacing="1" cellpadding="1" id=table1 width="100%" bgcolor="#ffffff">
            	<tr>
            	  <th colspan="2"><a href="?mod=Factura&action=autorizacambio&idfactura=<?php echo $id ?>&id_punto_venta=<?=$idpunto?>">Autorizar cambio</a></th>
           	  </tr>
            	<tr>
                	<th>
                    	Fecha Autorizacion
