					...
					<td colspan="2">
								...
								<div align="center">
												...
												<table class=rowtable>
													...
													<tr>
														...
														<td class=col2 colspan="3">
															...
															<input type="hidden" value="<?php echo $r->IDPuntoVenta ?>" name="IDPuntoVenta">
													...
													<tr>
														...
														<td class=col2 colspan="3"><textarea class="tareabox" name="ComentarioCredito" rows="4" cols="64"><?php echo $r->ComentarioCredito?></textarea></td>
													</tr>
													<tr>
														<td class=col1>Fecha Ultimo Comentario</td>
														<td class=col2 colspan="3"><?php echo $r->FechaUtimoComentario?></td>
													</tr>
													<tr>
										...
										?>
												<tr>
													...
													<td class="<?php echo $class?>" align="center">
														...
														{
														?>
																<input type="checkbox" class="seleccion_cuota_pago" name="CheckFechaPago<?php echo $r_cuotas->IDCuota?>" id="CheckFechaPago<?php echo $r_cuotas->IDCuota?>" alt="<?php echo $r_cuotas->IDCuota?>">
													...
													<td class="<?php echo $class?>" align="center">
														...
														{
														?>
																<select name="MedioPago<?php echo $r_cuotas->IDCuota?>" id="MedioPago<?php echo $r_cuotas->IDCuota?>" alt="<?php echo $r_cuotas->IDCuota?>" >
													...
													<td class="<?php echo $class?>" align="center">
														...
														?>
                                                                ...
                                                                <input type="text" class="tbox" name="FechaPago<?php echo $r_cuotas->IDCuota?>"  id="FechaPago<?php echo $r_cuotas->IDCuota?>" size="19" value='' <?php if($ID_Usuario!=57){ ?>readonly <?php } ?>  >
                                    ...
                                    <?php if($r->Estado=="ANULADA"): ?>
                                        FACTURA ANULADA
                                     <?php else: ?>
									<input value="Imprimir Factura" type="button" class="submit" onClick="window.open('Factura/FImpresion.php?id=<?php echo $r->IDFactura?>&idpunto=<?php echo $r->IDPuntoVenta?>','_blank','width=900,height=700,scrollbars=yes,resizable=yes')">
                                    <?php endif; ?>
				...
				<td class="forumlink" colspan="2">
					<table width=100% border=0 cellspacing=1 cellpadding=0>
							...
							<tr style="color:#EE080C">
								...
								<td nowrap class="<?php echo $class?>" <?php if($contador==0): echo 'style="color:#EE080C"'; endif; ?>><?php echo get_field("PuntoVenta","Nombre","IDPuntoVenta",$r->IDPuntoVenta);?></td>
									<td nowrap class="<?php echo $class?>" <?php if($contador==0): echo 'style="color:#EE080C"'; endif; ?>><?php echo get_field("Cliente","Nombre","IDCliente",$r->IDCliente)." ".get_field("Cliente","Apellido","IDCliente",$r->IDCliente)?></td>
									<td nowrap class="<?php echo $class?>" <?php if($contador==0): echo 'style="color:#EE080C"'; endif; ?>><?php echo $r->NumeroFactura ?></td>
									<td nowrap class="<?php echo $class?>" <?php if($contador==0): echo 'style="color:#EE080C"'; endif; ?>><?php echo formatofecha(substr($r->FechaFactura,0,10))." ".substr($r->FechaFactura,10) ?></td>
