							...
							<div align="center">
								<table width=100% border=0>
									...
									<tr>
										...
										<td class=texto align="right"><?php echo number_format($r->ValorTotalSinBono)?></td>
									</tr>
                                    <?php endif; ?>
								...
								?>
                                    ...
                                    <tr>
                                    	<td class="texto" colspan="4" align="center">
                                        	<a href="/admin/files/facturas/Factura<?php echo $r_puntoventa->Codigo.$r->NumeroFactura?>.pdf">Ver pdf</a>
                                        </td>
