	...
	<td>
		<table width=507 border=0 cellspacing=1 cellpadding=1 class=texto>
		  ...
		  <tr class=row2>
			  ...
			  <td></td>
			  <td>e-mail original1<br>
              <?php echo $r->EMailOriginal ?>"</td>
		  </tr>
...
*******************************************************************************************/
	...
	if(empty($sql))
		...
		$sql = str_replace("Where 1","Where 1 ",$sql);
	}
...
<tr>
	...
	?>
    <a href='<?php echo "?mod=$mod_edit&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
</td>
