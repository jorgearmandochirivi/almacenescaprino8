...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td>Mensaje</td><td><textarea name="Mensaje" rows="4" cols="40"><?=$r->Mensaje?></textarea></td>
			</tr>
						<tr class=row2>
							<td>Fecha Inicio</td>
							<td>
								<input type=text size=25 class=input name=FechaInicio id=Nombre value="<?=$r->FechaInicio ?>">
						...
						<tr class=row2>
							<td>Fecha Fin</td>
							<td>
								<input type=text size=25 class=input name=FechaFin id=Nombre value="<?=$r->FechaFin ?>">
								<script language="JavaScript1.2">
									<!--
										if (!document.layers)
			...
			<td> Publicar </td><td><? echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
						...
						<tr class=row2>
							<td>Segunda</td>
							<td><? echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Segunda, 'Segunda'); ?></td>
						</tr>
						<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDMensaje value="<?=$r->IDMensaje ?>">    <input type=hidden name=ID value="<? echo $r->$Key ?>">
...
<tr>
	...
	&nbsp;<a href='<? echo "?mod=$MOD&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
						...
						<td nowrap class=row1><? echo substr( $r->Mensaje, 0, 100 ) ?></td>
						<td nowrap class=row1><? echo $r->Publicar ?></td>
						<td nowrap class=row1><? echo $r->Segunda ?></td>
