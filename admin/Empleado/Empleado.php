...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=440 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<tr class=row2>
			<td>Cargo</td><td><? echo formpopup("Cargo","Cargo","Cargo","IDCargo",$r->IDCargo,"input validacargo\" id=\"Cargo"); ?>  </td>
			</tr>
			<tr class=row2>
			...
			?>
			<tr class=row2>
			<td>Punto de Venta</td><td><? echo formpopup("PuntoVenta","Nombre","Nombre","IDPuntoVenta",$r->IDPuntoVenta,"input validacargo\" id=\"PuntoVenta"," Publicar = 'S' "); ?></td>
			</tr>
			<?php
			}
			?>
