...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=440 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
				<td>Usuario</td>
				<td><input type=text size=25 class=input id=Usuario  name=User <?php  if($newmode == "update") echo "readonly"; ?> value="<?php echo $r->User ?>"></td>
			</tr>
						<tr class=row2>
				<td>Password</td>
			...
			<tr class=row2>
				...
				<td>
					...
					?>
                    <select name=Nivel>
						<?php foreach($array_nivel as $k => $N){?>
			...
			<tr class=row2>
			<td>Cargo</td><td><?php echo formpopup("Cargo","Cargo","Cargo","IDCargo",$r->IDCargo,"input validacargo\" id=\"Cargo"); ?>  </td>
			</tr>
			<tr class=row2>
			...
			?>
			<tr class=row2>
			<td>Punto de Venta</td><td><?php echo formpopup("PuntoVenta","Nombre","Nombre","IDPuntoVenta",$r->IDPuntoVenta,"input validacargo\" id=\"PuntoVenta"," Publicar = 'S' "); ?></td>
			</tr>
			<?php
			}
			?>
		...
		<table  cellpadding=0 cellspacing=0 align=center class=bordertable>
			...
			<td>
					<table width=100% border=0 cellspacing=1 cellpadding=0>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Apellidos&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Apellidos&nbsp;<?php  if($_GET['order_by']=="Apellidos"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDCargo&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Cargo&nbsp;<?php  if($_GET['order_by']=="IDCargo"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDComision&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDComision&nbsp;<?php  if($_GET['order_by']=="IDComision"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
