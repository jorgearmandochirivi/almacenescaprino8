...
<table width=700 cellpadding=0 cellspacing=0 align=center class=bordertable>
		...
		<tr>
			...
			<table width=100% border=0 cellspacing=1 cellpadding=0>
				...
				?>
  				<tr>
						<td nowrap class=row1><? echo get_field("Empleado","Nombre","IDEmpleado",$r->IDEmpleado)?></td>
					...
					<td nowrap class=row1><? echo formatofecha( $r->FechaInicio )?></td>
						...
						<td align=center valign=middle nowrap width=60 class=row1><? echo number_format( $r->Porcentaje )?></td>
						...
						<td align=center valign=middle nowrap width=60 class=row1><? echo number_format( $r->PorcentajePunto )?></td>
