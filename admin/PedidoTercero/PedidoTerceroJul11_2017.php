										...
										<?php 
											if(!empty($maximo_item[$id_talla]) ){
												...
												if(!empty($id_referencia)){
													...
													echo $existencias_item[$id_talla] = $rows["Existencias"];
...
?>
	...
	<tr>
                ...
                Numero Orden	 
                  <input type="text" name="NumeroOrdenCompra" id="NumeroOrdenCompra">
                ...
                Estado: 
                <select name="IDEstadoPedidoTercero" id="IDEstadoPedidoTercero">
                    <option value="">[Seleccione]</option>
                    <?php 
                ...
                <br>
                Referencia
                <input type="text" name="ReferenciaCaprino" id="ReferenciaCaprino">
