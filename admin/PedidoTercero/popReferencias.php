				...
				<td>
					...
					<table>
						<form action="<?php echo $PHP_SELF?>" method=get>
							<tr>
								<td class="<?php echo $class?>" colspan="3" nowrap align="left"><?php print($pages)?></td>
							</tr>
							<tr>
...
$array_tallas = array();
						...
						<tr>
							...
							?></tr>
						<tr>
							<td class="<?php echo $class?>" nowrap><?php echo $r->Numero ?></td>
							<td class="<?php echo $class?>"><?php echo $r->Nombre ?></td>
							<?php 							$numcols = 100;
							$contador = 1;
							foreach( $array_tallas as $key => $tallas )
							{
							?>
							<td class="<?php echo $class?>" align="left"><?php 											
