		...
		<table cellspacing='0' cellpadding='2' border='0' align='center' width='100%' bgcolor='#FFFFFF'>
			<tr>
				<td class=nav width=76%>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/folderopen.gif border=0>
					<a href="./?mod=<?php echo $MOD ?>">Administrar <?php echo $TitleMod ?></a>
				</td>
							...
							<table width="100%" border=0 cellspacing=1 cellpadding=1 class=texto>
								...
								<tr class=row2>
									...
									<td colspan="3" valign="middle">
										<textarea name="NotaPago" id="NotaPago" cols="80" rows="2"><?php if (!empty($r->NotaPago)) echo $r->NotaPago;
																									else echo get_field("ParametroTercero", "Descripcion", "IDParametroTercero", 7);  ?></textarea>
										15 Dias
								...
								<tr class=row2>
									<td>Nota 1</td>
									<td colspan="3"><textarea name="Nota1" class="" title="Nota1" id="Nota1" cols="140" rows="5"><?php if (!empty($r->Nota1)) echo $r->Nota1;
																																	else echo get_field("ParametroTercero", "Descripcion", "IDParametroTercero", 1);  ?></textarea></td>
								</tr>
								<tr class=row2>
									<td>Nota 2</td>
									<td colspan="3"><textarea name="Nota2" class="tbox" title="Nota1" id="Nota2" cols="140" rows="5"><?php if (!empty($r->Nota2)) echo $r->Nota2;
																																		else echo get_field("ParametroTercero", "Descripcion", "IDParametroTercero", 2);  ?></textarea></td>
								</tr>
								<tr class=row2>
									<td> Observaciones </td>
									<td colspan="3"><textarea name="Observaciones" class="tbox" title="Observaciones" id="Observaciones" cols="140" rows="5"><?php if (!empty($r->Observaciones)) echo $r->Observaciones;
																																								else echo get_field("ParametroTercero", "Descripcion", "IDParametroTercero", 4);  ?></textarea></td>
								</tr>
								<tr class=row2>
									<td colspan="4">
							...
							for ($i = 1; $i < $detalle_inicial; $i++):  ?>
								<tr>
									<td>
										...
										<input type=text size=7 class=input name="ReferenciaProveedor<?php echo $i ?>" id="ReferenciaProveedor<?php echo $i ?>" value="<?php echo $array_detalle_orden[$i]["ReferenciaProveedor"];  ?>">
									</td>
									...
									<td align="center">
										<?php if (!empty($array_detalle_orden[$i]["IDDetallePedidoTercero"]) && $r->IDEstadoPedidoTercero != 2): ?>
											<a href='<?php echo "?mod=$MOD&action=delitem&id=" . $r->$Key . "&iditem=";
														echo $array_detalle_orden[$i]["IDDetallePedidoTercero"]; ?>'><img src='images/trash.gif' border='0'></a>
										<?php endif; ?>
									</td>
								</tr>
							<?php
				...
				<table align="center" width="70%">
					...
					<tr>
						<td colspan=2 align=center class=row2>
							...
							<!-- <input type=hidden name="IDEstadoPedidoTercero" id="IDEstadoPedidoTercero" value=<?php if ($newmode == "insert") echo "1";
																													else echo $r->IDEstadoPedidoTercero ?>> -->

							<?php if ($r->IDEstadoPedidoTercero == 1 || $r->IDEstadoPedidoTercero == ""):  ?>
								<input type=submit name=submit value="<?php if ($newmode == "insert") echo "Guardar y Continuar";
																		else echo $submit_caption ?>" class=submit>
							<?php endif; ?>
						</td>
					</tr>
				</table>
						...
						<tr>
							<td colspan=2 align=center class=row2>
								...
								?>
										...
										<?php
										endif; // fin validacion si tiene por lo menos un producto pedido 
										?>
										<br />
								<?php
						...
						<table width=100% border=0 cellspacing=1 cellpadding=0>
							...
							?>
								...
								<tr>
									...
									<td align=center valign=middle nowrap width=69 class=row2>
										&nbsp;&nbsp;<a href='<?php echo "?mod=$MOD&action=del&id=";
																echo $r->$Key; ?>'><img src='images/trash.gif' border='0'></a>
									</td>
								</tr>
						...
						<tr>
							...
							<td><select name="IDPuntoVenta" id="IDPuntoVenta">
									...
									while ($punto = db_fetch_object($qry_punto)) {
										echo "<option value=$punto->IDPuntoVenta ";
										if ($IDPuntoVenta == $punto->IDPuntoVenta) echo "selected";
