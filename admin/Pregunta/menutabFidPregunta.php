				...
				<td>
					<table border="0" cellspacing="0" cellpadding="0" bgcolor="#02387A" id=TB1>
						<tr height="16">
							...
							<td valign="top" nowrap  height="16"><a href="./?mod=Fidelizacion&action=edit&id=<?php echo $IDFidPregunta?>" class="TAB" onMouseOut="mOut(TB1);" onMouseOver="mOvr(TB1);">Pregunta </a>&nbsp;
</td>
				...
				<td>
					<table border="0" cellspacing="0" cellpadding="0" bgcolor="#02387A" id=TB2>
						<tr height="16">
							...
							<td valign="top" nowrap onMouseOut="mOut(TB2);" onMouseOver="mOvr(TB2);" height="16"><a href="./?mod=Opciones&idPregunta=<?php echo $IDFidPregunta?>" class="TAB">Opciones</a></td>
							<td align="right" class="RightCurve" width="10" nowrap height="16">&nbsp;&nbsp;</td>
						</tr>
					</table>
				</td>
