...
<td> Poner espacio para pregunta "Cual" </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Cual, 'Cual'); ?></td>
	...
	<tr class=row2>
        ...
        <td>
			<input type="text" class=input  name=Orden id=Orden value="<?=$r->Orden ?>" ></td>
	</tr>
						<tr class=row2>
			<td width="50%" colspan="2"></td>
			</tr>
			<tr>
			<td align=center class=row2 colspan="2"><input type=hidden name=IDFidPregunta id=IDFidPregunta value="<?=$r->IDFidPregunta ?>"><input type=hidden name=UsuarioTrCr value="<?=$r->UsuarioTrCr ?>">
