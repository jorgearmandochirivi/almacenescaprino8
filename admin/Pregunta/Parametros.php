	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						...
						<tr class=row2>
                            ...
                            <td>
								<input type="text" name="Cantidad" class="tbox" value="<?=$r->Cantidad ?>">
							</td>
						</tr>
						<tr class=row2>
                            ...
                            <td>
								<input type="text" name="ValorDescuento" class="tbox" value="<?=$r->ValorDescuento ?>">
							</td>
						</tr>
			...
			<tr>
			<td align=center class=row2 colspan="2"><input type=hidden name=IDFidelizacion id=IDFidelizacion value="<?=$r->IDFidelizacion ?>"><input type=hidden name=UsuarioTrCr value="<?=$r->UsuarioTrCr ?>">
