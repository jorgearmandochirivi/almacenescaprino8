...
$TitleMod ="Parametros de la Fidelizacion";
...
?>
<script>
var Check = new Array('Cantidad','ValorDescuento');
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						...
						<tr class=row2>
                            ...
                            <td>
								<input type="text" name="Cantidad" class="tbox" value="<?php echo $r->Cantidad ?>">
							</td>
						</tr>
						<tr class=row2>
							<td width="50%">Valor del Descuento
                            </td>
                            <td>
								<input type="text" name="ValorDescuento" class="tbox" value="<?php echo $r->ValorDescuento ?>">
							</td>
						</tr>
			...
			<tr>
			<td align=center class=row2 colspan="2"><input type=hidden name=IDFidelizacion id=IDFidelizacion value="<?php echo $r->IDFidelizacion ?>"><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
...
<td nowrap class=row1><?php echo $r->Cantidad ?></td>
						<td nowrap class=row1><?php echo $r->ValorDescuento ?></td>
