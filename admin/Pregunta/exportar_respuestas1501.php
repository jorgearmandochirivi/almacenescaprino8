<?php
	...
	//$sql_clientes = " SELECT * FROM Cliente, FidClienteRespuesta WHERE Cliente.IDCliente = FidClienteRespuesta.IDCliente GROUP BY FidClienteRespuesta.IDCliente ";
     ...
     SELECT cl.*, fcr.*, Ciudad.Descripcion FROM Cliente cl, FidClienteRespuesta fcr, Ciudad WHERE cl.IDCliente = fcr.IDCliente and cl.IDCiudad = Ciudad.IDCiudad  GROUP BY fcr.IDCliente 
