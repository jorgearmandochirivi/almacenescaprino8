...
*******************************************************************************************/
	function list_r_primera($sql=""){
		Global $TitleMod,$MOD,$Table,$Key,$listar;	if(empty($sql))
...
while($ra = db_fetch_object($result_count )){
 ...
 //echo $queryupdate;
  ...
  /*  if($r->Facturas !=$NumeroFactu &&$r->Valor_Total !=$valortot ){
         $queryupdate= "Update Cliente set Facturas = '$NumeroFactu', Valor_Total = '$valortot' where IDCliente = $ra->IDCliente"; 
    }  
    else if($r->Facturas !=$NumeroFactu && $r->Valor_Total == $valortot){
         $queryupdate= "Update Cliente set Facturas = '$NumeroFactu' where IDCliente = $ra->IDCliente"; 
    }
     else if($r->Facturas ==$NumeroFactu && $r->Valor_Total != $valortot){
