...
<tr class=row2>
			<td> IDDetalleOrdenCompra </td><td><input type=text size=25 class=input  readonly name=IDDetalleOrdenCompra id=IDDetalleOrdenCompra value="<?php echo $r->IDDetalleOrdenCompra ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDOrdenCompra </td><td><input type=text size=25 class=input   name=IDOrdenCompra id=IDOrdenCompra value="<?php echo $r->IDOrdenCompra ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleOrdenCompra&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDDetalleOrdenCompra&nbsp;<?php  if($_GET['order_by']=="IDDetalleOrdenCompra"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDDetalleOrdenCompra ?></td> <td nowrap class=row1><?php echo $r->IDOrdenCompra ?></td> <td nowrap class=row1><?php echo $r->IDReferencia ?></td> <td nowrap class=row1><?php echo $r->Cantidad ?></td>
