...
$TitleMod ="DetalleOrdenCompra";

$Table = "DetalleOrdenCompra";
$TableJoin = "DetalleOrdenCompra";
$Key = "IDDetalleOrdenCompra";
$MOD = "DetalleOrdenCompra";
...
?>
<script>
var Check = new Array('IDDetalleOrdenCompra','IDOrdenCompra','IDReferencia','Cantidad','Publicar','UsuarioTrCr','FechaTrCr','UsuarioTrEd','FechaTrEd');
</script>
...
<tr class=row2>
			<td> IDDetalleOrdenCompra </td><td><input type=text size=25 class=input  readonly name=IDDetalleOrdenCompra id=IDDetalleOrdenCompra value="<?=$r->IDDetalleOrdenCompra ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDOrdenCompra </td><td><input type=text size=25 class=input   name=IDOrdenCompra id=IDOrdenCompra value="<?=$r->IDOrdenCompra ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleOrdenCompra&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDDetalleOrdenCompra&nbsp;<% if($_GET['order_by']=="IDDetalleOrdenCompra"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
...
<td nowrap class=row1><? echo $r->IDDetalleOrdenCompra ?></td> <td nowrap class=row1><? echo $r->IDOrdenCompra ?></td> <td nowrap class=row1><? echo $r->IDReferencia ?></td> <td nowrap class=row1><? echo $r->Cantidad ?></td>
