...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDOrdenCompra&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDOrdenCompra&nbsp;<?php if($_GET['order_by']=="IDOrdenCompra")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDSugerido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDSugerido&nbsp;<?php if($_GET['order_by']=="IDSugerido")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDEmpleado&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDEmpleado&nbsp;<?php if($_GET['order_by']=="IDEmpleado")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=NumeroOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">NumeroOrden&nbsp;<?php if($_GET['order_by']=="NumeroOrden")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=FechaOrden&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">FechaOrden&nbsp;<?php if($_GET['order_by']=="FechaOrden")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Estado&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Estado&nbsp;<?php if($_GET['order_by']=="Estado")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=ValorIVA&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">ValorIVA&nbsp;<?php if($_GET['order_by']=="ValorIVA")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Observaciones&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Observaciones&nbsp;<?php if($_GET['order_by']=="Observaciones")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
