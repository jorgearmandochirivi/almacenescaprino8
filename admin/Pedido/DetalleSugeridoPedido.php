...
$TitleMod ="DetalleSugeridoPedido";

$Table = "DetalleSugeridoPedido";
$TableJoin = "DetalleSugeridoPedido";
$Key = "IDSugeridoPedido";
$MOD = "DetalleSugeridoPedido";
...
?>
<script>
var Check = new Array('IDDetalleSugeridoPedido','IDSugeridoPedido','IDReferencia','Cantidad','Publicar','UsuarioTrCr','FechaTrCr','UsuarioTrEd','FechaTrEd');
</script>
...
<tr class=row2>
			<td> IDDetalleSugeridoPedido </td><td><input type=text size=25 class=input   name=IDDetalleSugeridoPedido id=IDDetalleSugeridoPedido value="<?=$r->IDDetalleSugeridoPedido ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDSugeridoPedido </td><td><input type=text size=25 class=input  readonly name=IDSugeridoPedido id=IDSugeridoPedido value="<?=$r->IDSugeridoPedido ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDDetalleSugeridoPedido&nbsp;<% if($_GET['order_by']=="IDDetalleSugeridoPedido"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDSugeridoPedido&nbsp;<% if($_GET['order_by']=="IDSugeridoPedido"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
...
<td nowrap class=row1><? echo $r->IDDetalleSugeridoPedido ?></td> <td nowrap class=row1><? echo $r->IDSugeridoPedido ?></td> <td nowrap class=row1><? echo $r->IDReferencia ?></td> <td nowrap class=row1><? echo $r->Cantidad ?></td>
