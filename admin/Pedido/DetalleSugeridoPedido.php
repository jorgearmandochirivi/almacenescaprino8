...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDDetalleSugeridoPedido&nbsp;<?php if($_GET['order_by']=="IDDetalleSugeridoPedido")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDSugeridoPedido&nbsp;<?php if($_GET['order_by']=="IDSugeridoPedido")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDReferencia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDReferencia&nbsp;<?php if($_GET['order_by']=="IDReferencia")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Cantidad&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Cantidad&nbsp;<?php if($_GET['order_by']=="Cantidad")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
