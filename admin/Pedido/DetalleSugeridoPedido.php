...
<tr class=row2>
			<td> IDDetalleSugeridoPedido </td><td><input type=text size=25 class=input   name=IDDetalleSugeridoPedido id=IDDetalleSugeridoPedido value="<?php echo $r->IDDetalleSugeridoPedido ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDSugeridoPedido </td><td><input type=text size=25 class=input  readonly name=IDSugeridoPedido id=IDSugeridoPedido value="<?php echo $r->IDSugeridoPedido ?>"> </td>
			</tr>
			<tr class=row2>
...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDDetalleSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDDetalleSugeridoPedido&nbsp;<?php  if($_GET['order_by']=="IDDetalleSugeridoPedido"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDSugeridoPedido&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDSugeridoPedido&nbsp;<?php  if($_GET['order_by']=="IDSugeridoPedido"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDDetalleSugeridoPedido ?></td> <td nowrap class=row1><?php echo $r->IDSugeridoPedido ?></td> <td nowrap class=row1><?php echo $r->IDReferencia ?></td> <td nowrap class=row1><?php echo $r->Cantidad ?></td>
