...
<tr class=row2>
			...
			<tr class=row2>
			<td> IDTipoTalla </td><td><?php echo formpopup("TipoTalla","Descripcion","Descripcion","IDTipoTalla",$r->IDTipoTalla,"input\" id=\"Tipo Talla"); ?> </td>
			</tr>
			<tr class=row2>
...
<table width=100% border=0 cellspacing=1 cellpadding=0>
	<tr>
		...
		<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTalla&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDTalla&nbsp;<?php if($_GET['order_by']=="IDTalla")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
	...
	<tr>
		...
		<td nowrap class=row1><?php echo $r->IDTalla ?></td> <td nowrap class=row1><?php echo $r->Descripcion ?></td> 
