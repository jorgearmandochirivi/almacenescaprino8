...
$Table = "ClienteSobrante";
$TableJoin = "Cliente";
$Key = "IDIDClienteSobrante	";
$MOD = "ExcedenteFidelizacion";
$m = "Fidelizacion";
...
*******************************************************************************************/
	function list_r( $idCliente ){
		Global $TitleMod,$MOD,$Table,$Key,$listar;
	 	...
	 	$sql =  "SELECT * FROM $Table WHERE IDCliente = '" . $idCliente . "' ORDER BY 2014-09-25 DESC ";
...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5>$ Valor Excente</td>
						<td class=rowform nowrap bgcolor=#DBEAF5>Fecha</td>
						<td class=rowform nowrap bgcolor=#DBEAF5>Numero Factura se sumo Excedente</td>
						<td class=rowform nowrap bgcolor=#DBEAF5>Fecha Utlizo Excedente</td>
