...
<table cellpadding=1 cellspacing=0 class=bordertable align=left >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						...
						<tr class=row2>
						  <td>Codigo</td>
						  <td><input type="text" name="Codigo" id="Codigo" title="Codigo" class="tbox" value="<?=$r->Codigo ?>"></td>
		  </tr>
						<tr class=row2>
						...
						<tr class=row2>
						  <td>Estado</td>
						  <td><span class="col2"><? echo formradiogroup(array('Activa'=>'A','Inactiva'=>'I','Entregada'=>'E','Perdida'=>'P'),$r->Estado, 'Estado'); ?></span></td>
		  </tr>
						<tr class=row2>
						  <td>Observacion</td>
						...
						<tr class=row2>
						  ...
						  <td>
                              <a href="?mod=ClienteFidelizado&action=edit&id=<?php echo $r->IDCliente; ?>&idnot=">
                                  <? echo get_field("Cliente","Nombre","IDCliente",$r->IDCliente) . " " . get_field("Cliente","Apellido","IDCliente",$r->IDCliente); ?>
                              </a>  
