...
this.imgURL = _editor_url + 'scripts/images/';
...
function editor_action(button_id) {
  ...
  if (cmdID == 'showhelp') {
    ...
    window.open(_editor_url + "scripts/popups/editor_help.html", 'EditorHelp');
  ...
  if (cmdID == 'popupeditor') {
    ...
    window.open(_editor_url + "scripts/popups/fullscreen.html?"+objname,
  ...
  // Custom2
    ...
    var myText = showModalDialog(_editor_url + "scripts/popups/custom2.html",
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "scripts/popups/select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "scripts/popups/insert_image.html", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    ...
    // insert table
      ...
      showModalDialog(_editor_url + "scripts/popups/insert_table.html?"+objname,
...
function editor_setmode(objname, mode) {
 ...
 // src="' +_editor_url+ 'scripts/popups/blank.html"
...
function editor_about(objname) {
  ...
  showModalDialog(_editor_url + "scripts/popups/about.html", window, "resizable: yes; help: no; status: no; scroll: no; ");
