<body> 
<?php 
$TitleMod ="Estado Garantia";

$Table = "EstadoGarantia";
$TableJoin = "";
$Key = "IDEstadoGarantia";
$MOD = "EstadoGarantia";
$m = "Garantia";
?>
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td> Publicar </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
						...
						<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDEstadoGarantia value="<?php echo $r->IDEstadoGarantia ?>">
