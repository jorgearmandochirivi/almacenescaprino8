...
?>
<script>
var Check = new Array('IDCuentaBanco','IDBanco','Nombre','NumeroCuenta','Publicar','UsuarioTrCr','FechaTrCr','UsuarioTrEd','FechaTrEd');
</script>
...
<tr class=row2>
			<td> IDCuentaBanco </td><td><input type=text size=25 class=input  readonly name=IDCuentaBanco id=IDCuentaBanco value="<?php echo $r->IDCuentaBanco ?>"> </td>
			</tr>
			<tr class=row2>
			<td> IDBanco </td><td><input type=text size=25 class=input   name=IDBanco id=IDBanco value="<?php echo $r->IDBanco ?>"> </td>
			</tr>
			<tr class=row2>
			<td> Nombre </td><td><input type=text size=25 class=input   name=Nombre id=Nombre value="<?php echo $r->Nombre ?>"> </td>
			</tr>
			<tr class=row2>
			<td> NumeroCuenta </td><td><input type=text size=25 class=input   name=NumeroCuenta id=NumeroCuenta value="<?php echo $r->NumeroCuenta ?>"> </td>
			</tr>
			<tr class=row2>
			<td> Publicar </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
			</tr>
			<tr class=row2>
			<td> UsuarioTrCr </td><td><input type=text size=25 class=input   name=UsuarioTrCr id=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>"> </td>
			</tr>
			<tr class=row2>
			<td> FechaTrCr </td><td><input type=text size=25 class=input   name=FechaTrCr id=FechaTrCr value="<?php echo $r->FechaTrCr ?>"> </td>
			</tr>
			<tr class=row2>
			<td> UsuarioTrEd </td><td><input type=text size=25 class=input   name=UsuarioTrEd id=UsuarioTrEd value="<?php echo $r->UsuarioTrEd ?>"> </td>
			</tr>
			<tr class=row2>
			<td> FechaTrEd </td><td><input type=text size=25 class=input   name=FechaTrEd id=FechaTrEd value="<?php echo $r->FechaTrEd ?>"> </td>
			</tr>
			<tr>
...
<tr>
	...
	<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDCuentaBanco&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDCuentaBanco&nbsp;<?php  if($_GET['order_by']=="IDCuentaBanco"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
	<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDBanco&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDBanco&nbsp;<?php  if($_GET['order_by']=="IDBanco"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
	...
	<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=NumeroCuenta&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">NumeroCuenta&nbsp;<?php  if($_GET['order_by']=="NumeroCuenta"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDCuentaBanco ?></td> <td nowrap class=row1><?php echo $r->IDBanco ?></td> <td nowrap class=row1><?php echo $r->Nombre ?></td> <td nowrap class=row1><?php echo $r->NumeroCuenta ?></td>
