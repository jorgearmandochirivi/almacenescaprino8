...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
					<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
							<td>Nombre</td>
							<td><input type=text size=25 class=input   name=Descripcion id=Descripcion value="<?php echo $r->Descripcion ?>"></td>
						</tr>
						<tr class=row2>
							<td>Descripcion</td>
							<td><input type=text size=25 class=input name=DescripcionLarga id=Descripcion value="<?php echo $r->DescripcionLarga ?>"></td>
						</tr>
						<tr class=row2>
							<td> Publicar </td>
						...
						<tr>
							<td colspan=2 align=center class=row2><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
...
<input type=hidden name=IDCuero id=IDCuero value="<?php echo $r->IDCuero ?>"><input type=submit name=submit value="<?php echo $submit_caption ?>" class=submit></td>
						</tr>
					</table>
				</td>
	</tr>
...
<td class=rowform nowrap bgColor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDCuero&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDCuero&nbsp;<?php  if($_GET['order_by']=="IDCuero"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
						<td class=rowform nowrap bgColor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Nombre <?php  if($_GET['order_by']=="Descripcion"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
