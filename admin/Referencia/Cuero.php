...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
					<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						...
						<tr class=row2>
							<td> Publicar </td>
							<td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
						</tr>
						<tr>
...
<input type=hidden name=IDCuero id=IDCuero value="<?=$r->IDCuero ?>"><input type=submit name=submit value="<?php echo $submit_caption ?>" class=submit></td>
						</tr>
					</table>
				</td>
	</tr>
...
<td class=rowform nowrap bgColor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDCuero&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDCuero&nbsp;<?php if($_GET['order_by']=="IDCuero")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
						<td class=rowform nowrap bgColor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Nombre <?php if($_GET['order_by']=="Descripcion")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a></td>
...
<td nowrap class=row1><?php echo $r->IDCuero ?></td>
