			...
			<tr>
				<td>
					<table border="0" cellspacing="0" cellpadding="0" bgcolor="#02387A" id=TB1>
						<tr height="16">
							...
							<td valign="top" nowrap  height="16"><a href="./?mod=Referencia&action=edit&id=<?php echo $idReferencia?>" class="TAB" onmouseout="mOut(TB1);" onmouseover="mOvr(TB1);">Referencias </a>&nbsp;
</td>
				...
				<td>
					<table border="0" cellspacing="0" cellpadding="0" bgcolor="#02387A" id=TB2>
						<tr height="16">
							...
							<td valign="top" nowrap onmouseout="mOut(TB2);" onmouseover="mOvr(TB2);" height="16"><a href="./?mod=CodEspecifica&idReferencia=<?php echo $idReferencia?>" class="TAB">Cod. Especifica</a></td>
							<td align="right" class="RightCurve" width="10" nowrap height="16">&nbsp;&nbsp;</td>
						</tr>
					</table>
				</td>
				...
				<td>
					<table border="0" cellspacing="0" cellpadding="0" bgcolor="#02387A" id=TB3>
						<tr height="16">
							<td class="LeftCurve" valign="top" align="left" width="12" height="16" nowrap>&nbsp;&nbsp;&nbsp;</td>
							<td valign="top" nowrap onmouseout="mOut(TB2);" onmouseover="mOvr(TB2);" height="16"><a href="./?mod=CostoReferencia&idReferencia=<?php echo $idReferencia?>" class="TAB">Costos</a></td>
							<td align="right" class="RightCurve" width="10" nowrap height="16">&nbsp;&nbsp;</td>
						</tr>
					</table>
				</td>
