		...
		<td>
			<table width=100% border=0 cellspacing=1 cellpadding=0>
				<tr>
					...
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Existencias&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Existencias&nbsp;<?php if($_GET['order_by']=="Existencias")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=ValorCompra&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">ValorCompra&nbsp;<?php if($_GET['order_by']=="ValorCompra")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=ValorVenta&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">ValorVenta&nbsp;<?php if($_GET['order_by']=="ValorVenta")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=PrecioMinimo&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">PrecioMinimo&nbsp;<?php if($_GET['order_by']=="PrecioMinimo")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=PrecioMaximo&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">PrecioMaximo&nbsp;<?php if($_GET['order_by']=="PrecioMaximo")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
