	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td> Nombre </td><td><input type=text size=25 class=input   name=Nombre id=Nombre value="<?php echo $r->Nombre ?>"> </td>
						...
						<tr class=row2>
			<td> Existencias </td><td><input type=text size=25 class=input   name=Existencias id=Existencias value="<?php echo $r->Existencias ?>"> </td>
			</tr>
			<tr class=row2>
			<td> ValorCompra </td><td><input type=text size=25 class=input   name=ValorCompra id=ValorCompra value="<?php echo $r->ValorCompra ?>"> </td>
			</tr>
			<tr class=row2>
			<td> ValorVenta </td><td><input type=text size=25 class=input   name=ValorVenta id=ValorVenta value="<?php echo $r->ValorVenta ?>"> </td>
			</tr>
			<tr class=row2>
			<td> PrecioMinimo </td><td><input type=text size=25 class=input   name=PrecioMinimo id=PrecioMinimo value="<?php echo $r->PrecioMinimo ?>"> </td>
			</tr>
			<tr class=row2>
			<td> PrecioMaximo </td><td><input type=text size=25 class=input   name=PrecioMaximo id=PrecioMaximo value="<?php echo $r->PrecioMaximo ?>"> </td>
			</tr>
			<tr class=row2>
			<td> Publicar </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
			</tr>
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden size=25 name=IDInventario id=IDInventario value="<?php echo $r->IDInventario ?>"><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
		...
		<td>
			<table width=100% border=0 cellspacing=1 cellpadding=0>
				<tr>
					...
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDInventario&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDInventario&nbsp;<?php  if($_GET['order_by']=="IDInventario"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
					...
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Existencias&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Existencias&nbsp;<?php  if($_GET['order_by']=="Existencias"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=ValorCompra&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">ValorCompra&nbsp;<?php  if($_GET['order_by']=="ValorCompra"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
					...
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=PrecioMinimo&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">PrecioMinimo&nbsp;<?php  if($_GET['order_by']=="PrecioMinimo"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
					<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=PrecioMaximo&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">PrecioMaximo&nbsp;<?php  if($_GET['order_by']=="PrecioMaximo"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDInventario ?></td> <td nowrap class=row1><?php echo $r->Nombre ?></td> <td nowrap class=row1><?php echo $r->Existencias ?></td> <td nowrap class=row1><?php echo $r->ValorCompra ?></td> <td nowrap class=row1><?php echo $r->ValorVenta ?></td> <td nowrap class=row1><?php echo $r->PrecioMinimo ?></td> <td nowrap class=row1><?php echo $r->PrecioMaximo ?></td>
