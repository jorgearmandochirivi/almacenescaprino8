...
?>
<script>
var Check = new Array('Nombre','Descripcion','Publicar');
</script>
...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
							<td>Tipo</td>
							<td><? echo formpopup("Tipo","Descripcion","Descripcion","IDTipo",$r->IDTipo,"input\" id=\"Tipo"); ?></td>
						</tr>
						<tr class=row2>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDLinea id=IDLinea value="<?=$r->IDLinea ?>"><input type=hidden name=UsuarioTrCr value="<?=$r->UsuarioTrCr ?>">
...
<tr>
<td class=texto bgcolor=#DBEAF5 colspan=15 nowrap>
<?
	print $pages;
?>
</td>
...
<td class=rowform nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href='<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDLinea&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'>Tipo</a><a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDLinea&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">&nbsp;<% if($_GET['order_by']=="IDLinea"){%><img src="images/<%=$img%>" border=0><%}%></a></td>
...
<td nowrap class=row1><? echo get_field( "Tipo","Descripcion","IDTipo",$r->IDTipo ) ?></td> <td nowrap class=row1><? echo $r->Nombre ?></td> <td nowrap class=row1><? echo $r->Descripcion ?></td>
