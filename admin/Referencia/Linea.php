...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
							<td>Tipo</td>
							<td><?php echo formpopup("Tipo","Descripcion","Descripcion","IDTipo",$r->IDTipo,"input\" id=\"Tipo"); ?></td>
						</tr>
						<tr class=row2>
...
<td nowrap class=row1><?php echo get_field( "Tipo","Descripcion","IDTipo",$r->IDTipo ) ?></td> <td nowrap class=row1><?php echo $r->Nombre ?></td> <td nowrap class=row1><?php echo $r->Descripcion ?></td>
