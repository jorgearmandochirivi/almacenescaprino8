...
<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDPlantilla&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDPlantilla&nbsp;<?php if($_GET['order_by']=="IDPlantilla")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
...
<td nowrap class=row1><?php echo $r->IDPlantilla ?></td>
