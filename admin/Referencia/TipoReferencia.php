	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td> Descripcion </td><td><input type=text size=25 class=input   name=Descripcion id=Descripcion value="<?php echo $r->Descripcion ?>"> </td>
						...
						<tr class=row2>
							<td>Codigo</td>
							<td><input type=text size=25 class=input   name=Codigo id=Descripcion value="<?php echo $r->Codigo ?>"></td>
						</tr>
						<tr class=row2>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDTipoReferencia id=IDTipoReferencia value="<?php echo $r->IDTipoReferencia ?>"><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
...
<td class=rowform nowrap bgColor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTipoReferencia&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">IDTipoReferencia&nbsp;<?php  if($_GET['order_by']=="IDTipoReferencia"){?><img src="images/<?php echo $img?>" border=0><?php }?></a> </td>
