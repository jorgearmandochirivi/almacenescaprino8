...
$TitleMod ="TipoReferencia";

$Table = "TipoReferencia";
$TableJoin = "TipoReferencia";
$Key = "IDTipoReferencia";
$MOD = "TipoReferencia";
$m="Referencia";
...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td> Descripcion </td><td><input type=text size=25 class=input   name=Descripcion id=Descripcion value="<?=$r->Descripcion ?>"> </td>
			</tr>
						<tr class=row2>
							<td>Codigo</td>
							<td><input type=text size=25 class=input   name=Codigo id=Descripcion value="<?=$r->Codigo ?>"></td>
						</tr>
						<tr class=row2>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDTipoReferencia id=IDTipoReferencia value="<?=$r->IDTipoReferencia ?>"><input type=hidden name=UsuarioTrCr value="<?=$r->UsuarioTrCr ?>">
...
<td class=rowform nowrap bgColor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTipoReferencia&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">IDTipoReferencia&nbsp;<% if($_GET['order_by']=="IDTipoReferencia"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
...
<td nowrap class=row1><? echo $r->IDTipoReferencia ?></td> <td nowrap class=row1><? echo $r->Descripcion ?></td>
