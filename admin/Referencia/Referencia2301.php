	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td width="50%">Color<br>
								<?php echo formpopup("Color","Nombre","Nombre","IDColor",$r->IDColor,"input\" id=\"Color"); ?></td><td>Linea<br>
								<select name=IDLinea>
								<option value="">[ Seleccione ]</option>
								<?php 
			...
			<td width="50%">Cuero<br>
								<?php echo formpopup("Cuero","Descripcion","Descripcion","IDCuero",$r->IDCuero,"input\" id=\"Cuero"); ?></td><td> Publicar<br>
								 <?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
			</tr>
						<tr class=row2>
							<td width="50%">Tipo de Referencia<br>
								<?php echo formpopup("TipoReferencia","Descripcion","Descripcion","TipoReferencia",$r->TipoReferencia,"input\" id=\"Tipo de Referencia"); ?></td>
							<td></td>
						</tr>
						<tr class=row3>
							<td colspan="2">
						...
						<tr class=row2>
							<td colspan="2"> Descripci&oacute;n <br>
								<textarea rows=5 cols=55 wrap=virtual name=Descripcion id=Descripcion><?php echo $r->Descripcion?></textarea></td>
						</tr>
						<tr class=row2>
	...
	<tr>
			<td>
				...
				<td class=rowform nowrap bgcolor=#DBEAF5><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTipoTalla&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Tipo de Talla</a><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDTipoTalla&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>"><?php  if($_GET['order_by']=="IDTipoTalla"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=IDLinea&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Tipo Ref.&nbsp;<?php  if($_GET['order_by']=="IDLinea"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
