...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descuento&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Descuento&nbsp;<?php if($_GET['order_by']=="Descuento")<?php <img src="images/<?php echo $img;?>" border=0><?php };?></a> </td>
