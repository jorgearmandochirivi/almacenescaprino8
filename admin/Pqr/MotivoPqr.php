...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
		  ...
		  <tr class=row2>
						  <td>Responsable</td>
						  <td><input type=text size=25 class=input   name=Responsable id=Responsable value="<?php echo $r->Responsable ?>"></td>
		  </tr>
						<tr class=row2>
						  <td>Correo Responsable</td>
						  <td><input type=text size=25 class=input   name=CorreoResponsable id=Nombre3 value="<?php echo $r->CorreoResponsable ?>"></td>
		  </tr>
						<tr class=row2>
			<td> Activo </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Activo, 'Activo'); ?></td>
			</tr>
						<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDAreaPqr value="<?php echo $r->IDAreaPqr ?>">
...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5><a style="color: #3A4F6C;text-decoration: none" href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Responsable</a><a style="color: #3A4F6C;text-decoration: none" href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>&nbsp;
						    <?php  if($_GET['order_by']=="Descripcion"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
						<td class=rowform nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Publicar&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">Activo&nbsp;
...
<tr>
	...
	&nbsp;<a href='<?php echo "?mod=$MOD&action=edit&id="; echo $r->$Key; ?>'><img src='images/edit.gif' border='0'></a>
						...
						<td nowrap class=row1><?php echo $r->Responsable ?></td>
