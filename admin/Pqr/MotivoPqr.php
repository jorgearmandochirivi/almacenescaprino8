...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
		  ...
		  <tr class=row2>
						  <td>Responsable</td>
						  <td><input type=text size=25 class=input   name=Responsable id=Responsable value="<?=$r->Responsable ?>"></td>
		  </tr>
						<tr class=row2>
						  <td>Correo Responsable</td>
						  <td><input type=text size=25 class=input   name=CorreoResponsable id=Nombre3 value="<?=$r->CorreoResponsable ?>"></td>
		  </tr>
						<tr class=row2>
			<td> Activo </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Activo, 'Activo'); ?></td>
			</tr>
						<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDAreaPqr value="<?=$r->IDAreaPqr ?>">
