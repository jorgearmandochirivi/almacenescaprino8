...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<td>Fecha</td>
			<td><input type=text size=25 class=input   name=Fecha id=Fecha value="<?=$r->Fecha ?>" <?php if($newmode=="update") echo "readonly"; ?>>
          ...
          <tr class=row2>
            ...
            <td><?php 						
						  ...
						  ?>
              <input type=text size=25 class=input   name=NumeroDocumento id=NumeroDocumento value="<?=$documento_cliente ?>">              
          ...
          <tr class=row2>
						  <td>Referencia</td>
						  <td><input type=text size=25 class=input   name=Referencia id=Referencia value="<?=$r->Referencia ?>"></td>
						  <td>Archivo</td>
