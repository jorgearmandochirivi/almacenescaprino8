		...
		switch (nvl($action)) {
			...
			case "update" :
				...
				if(empty($id_cliente)):
					...
					//Si se reasigna el area guardo el detalle
...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td> Numero </td>
			<td><input type=text size=25 class=input   name=Numero id=Numero value="<?php echo $r->Numero ?>" readonly> </td>
			<td>Fecha</td>
			<td><input type=text size=25 class=input   name=Fecha id=Fecha value="<?php echo $r->Fecha ?>" <?php if($newmode=="update") echo "readonly"; ?>>
          ...
          <tr class=row2>
            ...
            <td><?php 						
						  ...
						  ?>
              <input type=text size=25 class=input   name=NumeroDocumento id=NumeroDocumento value="<?php echo $documento_cliente ?>">              
              <input type=hidden size=25 class=input   name=IDCliente id=IDCliente value="<?php echo $r->IDCliente ?>"></td>
		                  <td>Datos Cliente</td>
		                  <td align="center"><?php echo "<br>" . $nombre_cliente . "<br> Telefono: " .  $telefono_cliente . " <br>" .  $correo_cliente; ?></td>
          </tr>
          <tr class=row2>
            <td>Motivo</td>
          ...
          <tr class=row2>
						  <td>Referencia</td>
						  <td><input type=text size=25 class=input   name=Referencia id=Referencia value="<?php echo $r->Referencia ?>"></td>
						  <td>Archivo</td>
        ...
        <?php
		 ...
		 ?>
          ...
          <?php endif; ?>
						...
						<tr>
			<td colspan=4 align=center class=row2><input type=hidden name=IDPqr value="<?php echo $r->IDPqr ?>">
                ...
                <input type=hidden name=IDMotivoPqrAnt value="<?php echo $r->IDMotivoPqr ?>">    
                <input type=hidden name=IDAreaPqrAnt value="<?php echo $r->IDAreaPqr ?>">                
...
<table width=500 cellpadding=0 cellspacing=0 align=center class=bordertable>
    ...
    <tr>
        ...
        <a href="Pqr/exportapqr.php?sql=<?php echo $sql; ?>"><img src="../images/excel_icon.gif" alt="" width="20" height="20" border="0" >Exportar Registros </a>
        </td>
	</tr>
...
<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5>Creado Por</td>
				...
				<td class="rowform" align="center" colspan=8>
					<table width="100%" border="0">
					  <tbody>
					    ...
					    <tr>
					      <td colspan="8" align="center"><input type="hidden" name="mod" value="<?php echo $MOD?>">
