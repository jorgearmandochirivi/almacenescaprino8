	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
		  ...
		  <tr class=row2>
						  <td>Descripcion</td>
						  <td>
                          <textarea name="Descripcion" id="Descripcion" rows="5" cols="30" class="input" ><?php echo $r->Descripcion ?></textarea>
                          </td>
		  </tr>

						<tr class=row2>
			<td> Activo </td><td><?php echo formradiogroup(array('Si'=>'S','No'=>'N'),$r->Publicar, 'Publicar'); ?></td>
			</tr>
						<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDTipoPqr value="<?php echo $r->IDTipoPqr ?>">
