...
$TitleMod ="Bonos de Pago";

$Table = "FormaPagoBono";
$TableJoin = "FormaPagoBonoFacturaBono";
$Key = "IDFormaPagoBono";
$MOD = "FormaPagoBono";
$m = "FormaPago";
...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
						<tr class=row2>
			<td>Descripcion</td><td><input type=text size=25 class=input   name=Descripcion id=Descripcion value="<?php echo $r->Descripcion ?>"> </td>
			</tr>
						<tr class=row2>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDFormaPagoBono id=IDFormaPagoBono value="<?php echo $r->IDFormaPagoBono ?>"><input type=hidden name=UsuarioTrCr value="<?php echo $r->UsuarioTrCr ?>">
	...
	<tr>
			...
			<table width=100% border=0 cellspacing=1 cellpadding=0>
				<tr>
						...
						<td class=rowform nowrap bgcolor=#DBEAF5><a href='<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>'>Descripcion</a><a style="color: #3A4F6C;text-decoration: none" href="<?php  echo "?mod=$MOD&field=".$_GET['field']."&QryString=".$_GET['QryString']."&order_by=Descripcion&in_order=".$order."&listar=".$nav->limit."&action=list"; ?>">&nbsp;<?php  if($_GET['order_by']=="Descripcion"){?><img src="images/<?php echo $img?>" border=0><?php }?></a></td>
				...
				?>
  				<tr>
					...
					<td align=center valign=middle nowrap width=60 class=row2>&nbsp;&nbsp;<a href='<?php echo "?mod=$MOD&action=del&id="; echo $r->$Key; ?>'><img src='images/trash.gif' border='0'></a></td>
				</tr>
				<?php } // END for
				?>
				<tr>
