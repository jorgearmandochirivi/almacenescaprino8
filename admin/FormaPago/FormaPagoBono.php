...
<table cellpadding=1 cellspacing=0 class=bordertable align=center >
	...
	<td>
		<table width=500 border=0 cellspacing=1 cellpadding=1 class=texto>
			...
			<tr>
			<td colspan=2 align=center class=row2><input type=hidden name=IDFormaPagoBono id=IDFormaPagoBono value="<?=$r->IDFormaPagoBono ?>"><input type=hidden name=UsuarioTrCr value="<?=$r->UsuarioTrCr ?>">
			...
			<table width=100% border=0 cellspacing=1 cellpadding=0>
				...
				?>
  				<tr>
					...
					<td align=center valign=middle nowrap width=60 class=row2>&nbsp;&nbsp;<a href='<? echo "?mod=$MOD&action=del&id="; echo $r->$Key; ?>'><img src='images/trash.gif' border='0'></a></td>
				</tr>
				<? } // END for
				?>
				<tr>
