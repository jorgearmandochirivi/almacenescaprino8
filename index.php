			...
			<tr height="42">
				<td align="right" valign="top" width="850" height="74" style="background-repeat:no-repeat;background-position: top right;" background="images/header_right2.jpg?<?= rand(1, 100) ?>">
					...
					<div id="datossession">
						...
						<font color="#000000">Sesi&oacute;n Activa:</font>
						<font color="#000000"><b><?= $Nombre_Usuario ?></b></font><br>
							...
							<div align="center"><span class="copyright"><br />
									...
									<div id="pienomostrar">
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<td><br>
													<img src="images/bt_left.gif" border="0" />
												</td>
												...
												<td><br>
													<img src="images/bt_right.gif" border="0" />
												</td>
											</tr>
										</table>
									</div>
