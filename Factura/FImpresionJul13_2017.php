...
<table  width="215" cellspacing="1" border="0" align="center" id="#content">
		<tr>
		  <td valign="top">.</td>
		  <td valign="top" align="left"><table width="90%" border=0 cellspacing=0 cellpadding=0 class=texto bgcolor="#ffffff">
				<tr>
						<td colspan="2">
							<div align="center">
									...
									<tr>
										<td colspan="4"><table class="bordertable" border="0" cellspacing="1" cellpadding="0" id=table1 width="90%">
										  <tr >
										    ...
										    <td align="center" class="texto"><b>Desc1</b></td>
										    <td align="center" class="texto" nowrap><b>Vr Desc</b></td>
										    <td align="center" class="texto"><b>Desc2</b></td>
