	...
	<table width="215" cellspacing="1" border="0" align="center" id="#content">
		<tr>
			...
			<td valign="top" align="left">
				<table width="98%" border=0 cellspacing=0 cellpadding=0 class=texto bgcolor="#ffffff">
					<tr>
						<td colspan="2">
							<div align="center">
								<table width=100% border=0>
									...
									<tr>
										<td colspan="4">
											<table class="bordertable" border="0" cellspacing="1" cellpadding="0" id=table1 width="90%">
												<tr>
												...
												?>
													<tr>
														...
														<td align="center" class="<?= $class ?>"><?php echo number_format($r_detalle->DescuentoRef); //number_format($r_detalle->DescuentoRef);
																									?>%</td>
														<td align="right" class="<?= $class ?>"><?php echo number_format($r_detalle->PrecioU); ?></td>
														<td align="center" class="<?= $class ?>"><?php echo number_format($r_detalle->DescuentoPar); //number_format($r_detalle->DescuentoRef);
																									?>%</td>
