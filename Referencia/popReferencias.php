						...
						<form action="<?=$PHP_SELF?>" method=get>
							...
							<tr>
								<td class="rowtable" colspan="3" nowrap>Por <select name="field" class="inputSelect">
									...
									</select> <input class="text tbox" type="text"  size="18" name="QryString"> <input type="hidden" name="action" value="list"> <input type="hidden" name="mod" value="busuario"> <input type="hidden" name="cont" value="<?=$cont?>"> <input type="hidden" name="IDPuntoVenta" value="<?=$IDPuntoVenta?>"> <input type="submit" name="submit" value="Buscar" class="submit"></td>
							</tr>
						</form>
						...
						<tr>
							...
							<td class="<?=$class?>" align="left"><?php
									if( $tallas['Existencias'] > 0 )
									{
										...
										// Los tipos 1 a 9 corresponden a calzado (mocasin, botin, bota,
										// sueco, zapatilla, zapato, sandalia y bota 3/4).
										$es_zapato = ((int)$r->IDTipoReferencia >= 1 && (int)$r->IDTipoReferencia <= 9) ? "1" : "0";
