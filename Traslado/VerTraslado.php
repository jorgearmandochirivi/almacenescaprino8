											...
											<td colspan="4">
												<table class=rowtable width="100%">
													...
													<tr>
														...
														<td class=col2><? echo get_field("EstadoTraslado","Descripcion","IDEstadoTraslado",$r->IDEstadoTraslado); ?></td>
				...
				<td class="forumlink" colspan="2">
                	<table width=100% border=0 cellspacing=1 cellpadding=0>
							<tr>
									...
									<td width="101" nowrap bgcolor=#DBEAF5 class=navpic><a style="color: #3A4F6C;text-decoration: none" href='<% echo "?mod=$MOD&field=".$_GET['field']."&IDPuntoVentaDestino=".$IDPuntoVenta."&QryString=".$_GET['QryString']."&order_by=Fecha&in_order=".$order."&listar=".$nav->limit."&action=list"; %>'>No. de Traslado</a></td>
									...
									<td width="78" nowrap bgcolor=#DBEAF5 class=navpic> <a style="color: #3A4F6C;text-decoration: none" href="<% echo "?mod=$MOD&field=".$_GET['field']."&IDPuntoVentaDestino=".$IDPuntoVenta."&QryString=".$_GET['QryString']."&order_by=Fecha&in_order=".$order."&listar=".$nav->limit."&action=list"; %>">Fecha&nbsp;<% if($_GET['order_by']=="Fecha"){%><img src="images/<%=$img%>" border=0><%}%></a> </td>
