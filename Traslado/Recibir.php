												...
												<td colspan="4">
													<table class=rowtable width="100%">
														...
														<tr>
															...
															<td class=col2><?php echo formpopup("EstadoTraslado", "Descripcion", "Descripcion", "IDEstadoTraslado", $r->IDEstadoTraslado, "input\" id=\"Estado"); ?></td>
							...
							<td class="forumlink" colspan="2">
								<table width=100% border=0 cellspacing=1 cellpadding=0>
									<tr>
										...
										<td class=navpic nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=" . $_GET['field'] . "&IDPuntoVentaDestino=" . $IDPuntoVenta . "&QryString=" . $_GET['QryString'] . "&order_by=IDPuntoVentaDestino&in_order=" . $order . "&listar=" . $nav->limit . "&action=list"; ?>">Almacen de Destino&nbsp;<?php if ($_GET['order_by'] == "IDPuntoVentaDestino") { ?><img src="images/<?php echo $img; ?>" border=0><?php } ?></a> </td>
										<td class=navpic nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=" . $_GET['field'] . "&IDPuntoVentaDestino=" . $IDPuntoVenta . "&QryString=" . $_GET['QryString'] . "&order_by=Fecha&in_order=" . $order . "&listar=" . $nav->limit . "&action=list"; ?>">Fecha&nbsp;<?php if ($_GET['order_by'] == "Fecha") { ?><img src="images/<?php echo $img; ?>" border=0><?php } ?></a> </td>
										<td class=navpic nowrap bgcolor=#DBEAF5> <a style="color: #3A4F6C;text-decoration: none" href="<?php echo "?mod=$MOD&field=" . $_GET['field'] . "&IDPuntoVentaDestino=" . $IDPuntoVenta . "&QryString=" . $_GET['QryString'] . "&order_by=IDEstadoTraslado&in_order=" . $order . "&listar=" . $nav->limit . "&action=list"; ?>">Estado&nbsp;<?php if ($_GET['order_by'] == "IDEstadoTraslado") { ?><img src="images/<?php echo $img; ?>" border=0><?php } ?></a> </td>
										...
										<tr>
											<td align=center valign=middle nowrap width=50 class="<?= $class ?>">
												&nbsp;<a href='<?php echo "?mod=$MOD&action=edit&id=";
																echo $r->$Key; ?>&idpuntoorigen=<?php echo $r->IDPuntoVentaOrigen; ?>'><img src='images/edit.gif' border='0'></a>
											</td>
											<td align=center valign=middle nowrap width=50 class="<?= $class ?>"><?php echo $r->IDTraslado; ?></td>
